window.webglZooming = (function(){
    ...
    webglZooming.prototype.getCurrentZoom = function()
    {
        return this.zoom;
    };

    webglZooming.prototype.init = function(element)
    {
    ...
    webglZooming.prototype.animate = function()
    {
    ...
    webglZooming.prototype.mouseWheel = function(e)
    {
        e = e ? e : window.event;
    ...
    webglZooming.prototype.changeZoom = function(zoom)
    {
        zoom *= 0.5;
        if (zoom < -0.5)
            zoom = -0.5;
    ...
    webglZooming.prototype.dispatchZoom = function(zoom)
    {
    ...
    webglZooming.prototype.bindEvent = function(element)
    {
    ...
    webglZooming.prototype.cancelEvent = function(e)
    {
        e = e ? e : window.event;
