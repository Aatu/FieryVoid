...
window.BlinkEffect = function () {
    function BlinkEffect(emitterContainer, args) {
        ...
        if (!BlinkEffect.cachedExplosionAudio) {
            BlinkEffect.cachedExplosionAudio = new Audio("client/renderer/animationStrategy/animation/sound/ExplosionAudio.wav");
        }
        */
        if (this.hit) {
            this.duration -= 25;
    ...
    BlinkEffect.prototype = Object.create(ParticleAnimation.prototype);

    BlinkEffect.prototype.getDuration = function () {
