window.ShipTooltip = (function(){
    ...
    function ShipTooltip(selectedShip, ships, position, showTargeting, menu){
        ...
        this.element.on('mouseover', function(e){e.preventDefault(); e.stopPropagation()});
        this.element.on('mousemove', function(e){e.preventDefault();});
        this.element.on('mouseout', function(e){e.preventDefault(); e.stopPropagation()});
