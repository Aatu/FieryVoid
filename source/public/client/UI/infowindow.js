...
window.infowindow = {
    ...
    initInfo: function initInfo() {
        if (infowindow.infoElement != null) return;
    ...
    hideInfo: function hideInfo(timeout) {
        setTimeout(function () {
            infowindow.infoElement.fadeTo(1000, 0).hide();
        }, timeout);
    },

    informFire: function informFire(timeout, fire, firstcallback, callback) {
        infowindow.initInfo();
