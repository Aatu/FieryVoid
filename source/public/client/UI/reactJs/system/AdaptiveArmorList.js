...
class AdaptiveArmorList extends Component {
    ...
    getRelevantArmorTypes() {
        const { ship, system } = this.props;
        // Delegate to the system method so the UI and the commit-time AA warning
        // (gamedata.onCommitClicked) always agree on which types are reachable.
        return system.getRelevantArmorTypes(ship);
    }
