...
},{"./emptyFunction":6,"_process":21}],2:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./emptyFunction":6,"_process":21}],17:[function(require,module,exports){
/**
...
},{"./lib/ReactPropTypesSecret":26,"_process":21,"fbjs/lib/invariant":12,"fbjs/lib/warning":16}],23:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":26,"fbjs/lib/emptyFunction":6,"fbjs/lib/invariant":12}],24:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":22,"./lib/ReactPropTypesSecret":26,"_process":21,"fbjs/lib/emptyFunction":6,"fbjs/lib/invariant":12,"fbjs/lib/warning":16,"object-assign":20}],25:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"_process":21,"fbjs/lib/EventListener":1,"fbjs/lib/ExecutionEnvironment":2,"fbjs/lib/camelizeStyleName":4,"fbjs/lib/containsNode":5,"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/focusNode":8,"fbjs/lib/getActiveElement":9,"fbjs/lib/hyphenateStyleName":11,"fbjs/lib/invariant":12,"fbjs/lib/shallowEqual":15,"fbjs/lib/warning":16,"object-assign":20,"prop-types/checkPropTypes":22,"react":32}],28:[function(require,module,exports){
/** @license React v16.2.0
...
},{"fbjs/lib/EventListener":1,"fbjs/lib/ExecutionEnvironment":2,"fbjs/lib/containsNode":5,"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/focusNode":8,"fbjs/lib/getActiveElement":9,"fbjs/lib/shallowEqual":15,"object-assign":20,"react":32}],29:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":21,"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/invariant":12,"fbjs/lib/warning":16,"object-assign":20,"prop-types/checkPropTypes":22}],31:[function(require,module,exports){
/** @license React v16.2.0
...
},{"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"object-assign":20}],32:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":21,"hoist-non-react-statics":17,"is-plain-object":18,"prop-types":25,"react":32,"stylis":35,"stylis-rule-sheet":34}],34:[function(require,module,exports){
(function (factory) {
...
var _PlayerSettings2 = require("./playerSettings/PlayerSettings");
...
},{"./playerSettings/PlayerSettings":39,"react":32,"react-dom":29}],37:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.InputAndLabel = undefined;
...
var InputAndLabel = function (_React$Component) {
    _inherits(InputAndLabel, _React$Component);

    function InputAndLabel() {
        _classCallCheck(this, InputAndLabel);

        return _possibleConstructorReturn(this, (InputAndLabel.__proto__ || Object.getPrototypeOf(InputAndLabel)).apply(this, arguments));
    }

    _createClass(InputAndLabel, [{
        key: "render",
...
var Label = /*#__PURE__*/_styledComponents2.default.span(_templateObject2);

var Input = /*#__PURE__*/_styledComponents2.default.input(_templateObject2);

exports.InputAndLabel = InputAndLabel;

},{"react":32,"styled-components":33}],38:[function(require,module,exports){
"use strict";
...
var _InputAndLabel = require("./InputAndLabel");

Object.defineProperty(exports, "InputAndLabel", {
  enumerable: true,
  get: function get() {
    return _InputAndLabel.InputAndLabel;
  }
});

},{"./InputAndLabel":37}],39:[function(require,module,exports){
"use strict";
...
var _PlayerSettingsForm = require("./PlayerSettingsForm");

var _PlayerSettingsForm2 = _interopRequireDefault(_PlayerSettingsForm);
...
var PlayerSettings = function (_React$Component) {
    _inherits(PlayerSettings, _React$Component);

    function PlayerSettings(props) {
        _classCallCheck(this, PlayerSettings);

        var _this = _possibleConstructorReturn(this, (PlayerSettings.__proto__ || Object.getPrototypeOf(PlayerSettings)).call(this, props));

        _this.state = { open: false };
        return _this;
    }

    _createClass(PlayerSettings, [{
        key: "open",
        value: function open() {
        ...
        value: function render() {
            ...
            return React.createElement(_PlayerSettingsForm2.default, _extends({ close: this.close.bind(this) }, this.props));
        }
    }]);
...
var MainButton = _styled.ContainerRoundedRightBottom.extend(_templateObject, _styled.Clickable);

exports.default = PlayerSettings;

},{"../styled":44,"./PlayerSettingsForm":40,"react":32}],40:[function(require,module,exports){
"use strict";
...
var PlayerSettingsForm = function (_React$Component) {
    _inherits(PlayerSettingsForm, _React$Component);

    function PlayerSettingsForm() {
        _classCallCheck(this, PlayerSettingsForm);

        return _possibleConstructorReturn(this, (PlayerSettingsForm.__proto__ || Object.getPrototypeOf(PlayerSettingsForm)).apply(this, arguments));
    }

    _createClass(PlayerSettingsForm, [{
        key: "getOnChange",
        value: function getOnChange(key) {
            var _this2 = this;

            return function (e) {
                _this2.props.set(key, e.target.value);
                _this2.props.save();
                _this2.forceUpdate();
            };
        }
        ...
        key: "getOnKeyDown",
        value: function getOnKeyDown(key) {
            var _this3 = this;
            ...
            return function (e) {
                ...
                _this3.props.set(key, keyDefinition);
                _this3.props.save();
                _this3.forceUpdate();
            };
        }
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        Paragraph,
                        null,
                        "Change settings for currently used browser and device. Reload the page to apply changed settings."
                    ),
                    React.createElement(
                        _styled.SubTitle,
                        null,
    ...
    return PlayerSettingsForm;
}(React.Component);

var keyToString = function keyToString(key) {
    var value = keyCodes[key.keyCode];
...
var CloseButton = /*#__PURE__*/_styledComponents2.default.div(_templateObject, _styled.Clickable);

var SubContainer = _styled.Container.extend(_templateObject2);

var Paragraph = /*#__PURE__*/_styledComponents2.default.p(_templateObject3);
...
},{"../common":38,"../styled":44,"react":32,"styled-components":33}],41:[function(require,module,exports){
'use strict';
...
var Clickable = /*#__PURE__*/(0, _styledComponents.css)(_templateObject);

exports.Clickable = Clickable;

},{"styled-components":33}],42:[function(require,module,exports){
"use strict";
...
var Backdrop = /*#__PURE__*/_styledComponents2.default.div(_templateObject2);
...
},{"styled-components":33}],43:[function(require,module,exports){
"use strict";
...
var Title = /*#__PURE__*/_styledComponents2.default.span(_templateObject);
...
},{"styled-components":33}],44:[function(require,module,exports){
"use strict";
...
},{"./Clickable":41,"./Container":42,"./Title":43}]},{},[36]);
