...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`,gt,Kt,_a,Kt),br[Kt+gt]=!0}}return L===g?Di(Cn):$a(Cn),Cn}}function oi(L,ce,Ee){return Mi(L,ce,Ee,!0)}function Aa(L,ce,Ee){return Mi(L,ce,Ee,!1)}var ja=Aa,ao=oi;ap.Fragment=g,ap.jsx=ja,ap.jsxs=ao}(),ap}var nD={};nD.NODE_ENV==="production"?qy.exports=eD():qy.exports=tD();var v=qy.exports,Zy={exports:{}},Ui={},Cg={exports:{}},Jy={};/**
 * @license React
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://reactjs.org/link/wrap-tests-with-act`,lt(e))}finally{t?ln(e):jn()}}}}function v5(e){e.tag!==ou&&Yk()&&Ao.current===null&&y(`A suspended resource finished loading inside a test, but the event was not wrapped in act(...).
...
`;class Ta extends Ze.Component{render(){return v.jsxs(xM,{children:[v.jsx(bM,{children:this.props.label}),v.jsx(wM,{type:this.props.type||"text",value:this.props.value,placeholder:this.props.placeholder,onKeyDown:this.props.onKeydown,onChange:this.props.onChange,tabIndex:"0"})]})}}const xM=D.div`
    width: 100%;
...
`;class SM extends Ze.Component{render(){const{children:r,className:s}=this.props;return v.jsx("div",{className:s,children:r})}}const xx=D(SM)`
    z-index:7001;
    position:absolute;
    text-align:center;
    font-family:${H.fonts.body};
...
`,B1=D(ku)`
    ${Vi}
`;class BM extends Ze.Component{constructor(r){super(r)}ready(){window.shipManager.movement.doneAssignThrust(this.props.ship)}cancel(){window.shipManager.movement.cancelAssignThrustEvent(this.props.ship)}resetThrust(){const r=this.props.ship;window.shipManager.movement.revertAutoThrust(r),window.shipManager.movement.updateAssignThrust(r)}autoAssign(){const r=this.props.ship;window.shipManager.movement.revertAutoThrust(r),window.shipManager.movement.autoAssignThrust(r),window.shipManager.movement.updateAssignThrust(r)}render(){const{ship:r,position:s,rotation:d,totalRequired:g,remainginRequired:b,movement:S}=this.props;return v.jsxs(FM,{onMouseOver:y=>y.preventDefault(),onContextMenu:y=>y.preventDefault(),id:"thrustUIContainer",$left:`${s.x}px`,$top:`${s.y}px`,children:[v.jsxs(PM,{style:{transform:`rotate(${Math.round(Math.abs(d))}deg)`},$rotation:Math.round(Math.abs(d)),children:[v.jsx(F1,{children:Hg(r,1,g,b)}),v.jsx(I1,{children:Hg(r,3,g,b)}),v.jsx(NM,{children:Hg(r,4,g,b)}),v.jsx(zM,{children:Hg(r,2,g,b)})]}),v.jsxs(IM,{children:[v.jsx(bx,{children:"Assign thrust"}),WM(g,b,S),HM(r),VM(r,S),v.jsx(B1,{$space:!0,$important:!0,onClick:this.resetThrust.bind(this),children:"RESET THRUST"}),v.jsx(B1,{$important:!0,onClick:this.autoAssign.bind(this),children:"AUTO ASSIGN"}),v.jsxs(UM,{children:[v.jsx(U1,{onClick:this.ready.bind(this),children:"✔"}),v.jsx(U1,{onClick:this.cancel.bind(this),children:"🛇"})]})]})]})}}const HM=o=>{const r=shipManager.movement.getRemainingEngineThrust(o);return v.jsxs(ku,{$space:!0,$important:!0,children:["Thrust available: ",r]})},VM=(o,r)=>{if(!shipManager.movement.isTurn(r))return null;const s=shipManager.movement.calculateTurndelay(o,r,r.speed);return v.jsxs(ku,{$important:!0,children:["Current turn delay: ",s]})},WM=(o,r,s)=>{const d=Array("either","front","aft","port","starboard");s.type=="roll"&&(d[0]="any");const g=r.map((b,S)=>b<=0||b===null?null:v.jsxs(ku,{$type:b===0?"good":"bad",children:[b," thrust to ",d[S]," thrusters"]},`assign-thrust-text-${S}`)).filter(b=>b!==null);return g.length===0?v.jsx(ku,{$type:"good",children:"All done!"}):g},Hg=(o,r,s,d)=>{const g=shipManager.systems.getThrusters(o,r);return d.type!=="roll"&&s[r]===null?null:g.map((b,S)=>{const y=()=>{shipManager.movement.assignThrust(o,b),shipManager.movement.updateAssignThrust(o)},T=_=>{_.preventDefault(),shipManager.movement.unAssignThrust(o,b),shipManager.movement.updateAssignThrust(o)};let $=shipManager.criticals.hasCritical(b,"HalfEfficiency")?10:0;shipManager.criticals.hasCritical(b,"FirstThrustIgnored")&&($+=1);const O=shipManager.movement.getAmountChanneled(o,b),P=shipManager.systems.getOutput(o,b);return v.jsx(LM,{$crits:$,onClick:y,onContextMenu:T,$direction:r,children:v.jsxs(N1,{children:[O,"/",P]})},`thruster-${r}-${S}`)})},YM=()=>v.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",focusable:"false",children:[v.jsx("path",{d:"M9 3H3v6"}),v.jsx("path",{d:"M15 3h6v6"}),v.jsx("path",{d:"M9 21H3v-6"}),v.jsx("path",{d:"M15 21h6v-6"})]});class GM extends Ze.Component{fullScreen(){var r=window.document,s=r.documentElement,d=s.requestFullscreen||s.mozRequestFullScreen||s.webkitRequestFullScreen||s.msRequestFullscreen,g=r.exitFullscreen||r.mozCancelFullScreen||r.webkitExitFullscreen||r.msExitFullscreen;!r.fullscreenElement&&!r.mozFullScreenElement&&!r.webkitFullscreenElement&&!r.msFullscreenElement?d.call(s):g.call(r)}render(){return v.jsx(KM,{onClick:this.fullScreen.bind(this),title:"Full screen",children:v.jsx(YM,{})})}}const KM=D(Ug)`
    width: ${H.hud.btn};
    height: ${H.hud.btn};
    position: fixed;
...
`;class QM extends Ze.Component{constructor(r){super(r),this.state={available:H1()},this.surrender=this.surrender.bind(this)}componentDidMount(){this.availabilityCheck=setInterval(()=>{const r=H1();this.state.available!==r&&this.setState({available:r})},500)}componentWillUnmount(){clearInterval(this.availabilityCheck)}surrender(){window.gamedata.onSurrenderClicked()}render(){return this.state.available?v.jsx(XM,{onClick:this.surrender,title:"Surrender",children:v.jsx("img",{src:qM(),alt:""})}):null}}const H1=()=>{if(typeof window.gamedata>"u")return!1;const o=window.gamedata;if(o.replay||!o.isPlayerInGame()||o.status==="SURRENDERED"||o.status==="FINISHED")return!1;for(const r in o.slots){const s=o.slots[r];if(s.playerid==o.thisplayer&&s.surrendered!==null&&s.surrendered!==void 0)return!1}return!0},qM=()=>{const o="./img/surrender_icon1.png";return window.AssetManager?window.AssetManager.getSmartImagePath(o):o},V1="34px",W1="22px",XM=D(Ug)`
    width: ${H.hud.btn};
    height: ${H.hud.btn};
    position: fixed;
...
`,dO=D.div`
    ...
    -ms-user-select: none;
    user-select: none;
`;class fO extends Ze.Component{selectMode(r,s){r.stopPropagation(),r.preventDefault();const{ship:d,system:g}=this.props;weaponManager.onSetModeClicked(d,g,s)}selectAllMode(r,s){r.stopPropagation(),r.preventDefault();const{ship:d,system:g}=this.props;weaponManager.onSetModeAllClicked(d,g,s)}render(){const{ship:r,system:s}=this.props,d=this.props.showModes!==!1,g=parseInt(s.firingMode);let b="";s.iconPath?b=`./img/systemicons/${s.iconPath}`:b=`./img/systemicons/${s.name}.png`;const S=[];for(const y in s.firingModes)if(s.firingModes.hasOwnProperty(y)){const T=parseInt(y),$=s.firingModes[y],O=T===g;let P=s.modeLetters||1;s.modeLettersArray&&s.modeLettersArray[T]&&(P=s.modeLettersArray[T]),S.push(v.jsx(dO,{img:b,selected:O,onClick:_=>this.selectMode(_,T),onContextMenu:_=>this.selectAllMode(_,T),title:`Set mode: ${$} ${O?"(Current)":""} (Right click to set all)`,children:$.substring(0,P)},T))}return v.jsxs(sO,{children:[d&&v.jsx(uO,{children:"Select Firing Mode"}),v.jsxs(cO,{children:[d&&S,this.props.children]})]})}}const pO=D.div`
    display: flex;
    flex-direction: column;
    margin-top: 1px;
    width: 100%;
...
`,Wg=D.div`
    ...
    ${o=>!o.disabled&&Vi}
`,s$=o=>window.gamedata.turn===window.shipManager.getTurnPlaced(o)&&window.gamedata.gamephase===-1;class u$ extends Ze.Component{constructor(r){super(r)}handleSelect(r){const{system:s}=this.props;s.specCurrClass=r,s.canSelect()&&(s.doSelect(),this.forceUpdate())}handleUnselect(r){const{system:s}=this.props;s.specCurrClass=r,s.canUnselect()&&(s.doUnselect(),this.forceUpdate())}handleUse(r){const{system:s}=this.props;s.specCurrClass=r,s.canUse()&&(s.doUse(),this.forceUpdate())}handleCancel(r){const{system:s}=this.props;s.specCurrClass=r,s.canDecrease()&&(s.doDecrease(),this.forceUpdate())}render(){const{ship:r,system:s}=this.props;if(!s)return null;const d=s$(r);let g=[];d?s.allSpec&&(g=Object.keys(s.allSpec)):s.availableSpec&&(g=Object.keys(s.availableSpec).filter(S=>s.availableSpec[S]>0)),g.sort();let b="";return d?b=`Specialists Selected: ${Object.values(s.availableSpec||{}).reduce((y,T)=>y+T,0)} / ${s.specTotal}`:b=`Specialists Used: ${s.specTotal_used||0} / ${s.specTotal}`,v.jsxs(n$,{children:[v.jsx(r$,{children:"Hyach Specialists"}),v.jsxs(i$,{children:[g.map(S=>{const y=d&&(s.specCurrClass=S,s.canSelect()),T=d&&(s.specCurrClass=S,s.canUnselect()),$=!d&&(s.specCurrClass=S,s.canUse()),O=!d&&(s.specCurrClass=S,s.canDecrease());s.availableSpec&&s.availableSpec[S]>0,s.currAllocatedSpec&&s.currAllocatedSpec[S];const P=`./img/systemicons/Specialistclasses/${S}.png?v=2`;return v.jsxs(J1,{children:[v.jsx(a$,{src:P,alt:S}),v.jsx(o$,{children:S}),v.jsx(l$,{children:d?v.jsxs(v.Fragment,{children:[v.jsx(Wg,{onClick:()=>this.handleUnselect(S),disabled:!T,children:v.jsx("img",{src:"./img/systemicons/Specialistclasses/iconMinus.png",style:{width:"12px",height:"12px"},alt:"Cancel"})}),v.jsx(Wg,{onClick:()=>this.handleSelect(S),disabled:!y,children:v.jsx("img",{src:"./img/systemicons/Specialistclasses/iconPlus.png",style:{width:"12px",height:"12px"},alt:"Use"})})]}):v.jsxs(v.Fragment,{children:[v.jsx(Wg,{onClick:()=>this.handleUse(S),disabled:!$,children:v.jsx("img",{src:"./img/systemicons/Specialistclasses/iconPlus.png",style:{width:"12px",height:"12px"},alt:"Use"})}),v.jsx(Wg,{onClick:()=>this.handleCancel(S),disabled:!O,children:v.jsx("img",{src:"./img/systemicons/Specialistclasses/iconMinus.png",style:{width:"12px",height:"12px"},alt:"Cancel"})})]})})]},S)}),g.length===0&&v.jsx(J1,{style:{justifyContent:"center",fontStyle:"italic"},children:"No Specialists Available"})]}),v.jsx("div",{style:{padding:"5px",textAlign:"center",fontSize:"10px",color:"#f2f2f2"},children:b})]})}}const c$=D.div`
    display: flex;
    flex-direction: column;
    margin-top: 5px;
    width: 100%;
...
`,Ru=D.div`
    ...
    ${o=>o.disabled&&`
        ...
        &:hover { background: #1b5e20; border: 1px solid #2e7d32; color: #e6ffe6; }
    `}
`;class q$ extends Ze.Component{refresh(){const{ship:r,system:s}=this.props;this.forceUpdate(),webglScene.customEvent("SystemDataChanged",{ship:r,system:s})}cycleMode(r){const{system:s}=this.props;if(!gamedata.isMyShip(this.props.ship))return;const d=s.firingMode==1?2:1;s.setFiringMode(d),typeof s.initializationUpdate=="function"&&s.initializationUpdate(),this.refresh()}activateMode1(){const{ship:r,system:s}=this.props;s.canActivate()&&(s.doActivate(),webglScene.customEvent("SystemDataChanged",{ship:r,system:s}),webglScene.customEvent("CloseSystemInfo"))}targetWarrior(){const{ship:r,system:s}=this.props;weaponManager.isSelectedWeapon(s)||weaponManager.selectWeapon(r,s),webglScene.customEvent("SystemDataChanged",{ship:r,system:s}),webglScene.customEvent("CloseSystemInfo")}setRotation(r,s){const{system:d}=this.props;d.rotationDirection=r,d.rotationAmount=s,typeof d.updateRotationNotes=="function"&&d.updateRotationNotes(),this.refresh()}renderInitialOrders(){const{system:r}=this.props,s=parseInt(r.firingMode,10),d=r.firingModes[s]||"";return v.jsxs(Ox,{children:[v.jsxs(K$,{children:[v.jsx(cC,{onClick:()=>this.cycleMode(-1),title:"Previous mode",children:"<"}),v.jsx(Q$,{children:d}),v.jsx(cC,{onClick:()=>this.cycleMode(1),title:"Next mode",children:">"})]}),s==1&&v.jsx(dp,{children:v.jsx(Ru,{onClick:()=>this.activateMode1(),children:"Activate"})}),s==2&&v.jsx(dp,{children:v.jsx(Ru,{onClick:()=>this.targetWarrior(),$active:weaponManager.isSelectedWeapon(r),children:"Target friendly Warrior"})})]})}engageMode3(){const{ship:r,system:s}=this.props;gamedata.isMyShip(r)&&(weaponManager.hasFiringOrder(r,s)||(s.setFiringMode(3),typeof s.initializationUpdate=="function"&&s.initializationUpdate(),this.refresh()))}renderPreFiring(){const{system:r}=this.props;if(r.firingMode!=3)return v.jsxs(Ox,{children:[v.jsx(uC,{children:"Gravitic Augmenter"}),v.jsx(dp,{children:v.jsx(Ru,{onClick:()=>this.engageMode3(),children:"Engage Gravity Shifting"})})]});const s=r.rotationDirection||1,d=r.rotationAmount||1,g=(b,S)=>s==b&&d==S;return v.jsxs(Ox,{children:[v.jsx(uC,{children:"Gravity Shift Settings"}),v.jsxs(dp,{children:[v.jsx(dC,{children:"Clockwise"}),v.jsx(Ru,{onClick:()=>this.setRotation(1,1),$active:g(1,1),children:"60°"}),v.jsx(Ru,{onClick:()=>this.setRotation(1,2),$active:g(1,2),children:"120°"})]}),v.jsxs(dp,{children:[v.jsx(dC,{children:"Anti-Clockwise"}),v.jsx(Ru,{onClick:()=>this.setRotation(2,1),$active:g(2,1),children:"60°"}),v.jsx(Ru,{onClick:()=>this.setRotation(2,2),$active:g(2,2),children:"120°"})]})]})}render(){const{system:r}=this.props;return r?gamedata.gamephase==1?(r.firingMode==3&&(r.setFiringMode(1),typeof r.initializationUpdate=="function"&&r.initializationUpdate()),this.renderInitialOrders()):gamedata.gamephase==5?this.renderPreFiring():null:null}}const Gg=3,X$=D.div`
    display: flex;
    flex-direction: column;
    margin-top: 5px;
    width: 100%;
...
`;class kA extends Ze.Component{constructor(r){super(r),this.wheelRef=fp(s=>this.step(s.deltaY<0?1:-1))}step(r){const{row:s,onChange:d}=this.props,g=Math.max(0,Math.min(s.max,s.count+r));g!==s.count&&d(s.enhID,g)}onInput(r){const{row:s,onChange:d}=this.props,g=String(r.target.value).replace(/[^0-9]/g,""),b=g===""?0:parseInt(g,10);d(s.enhID,Math.max(0,Math.min(s.max,b)))}render(){const{row:r}=this.props,s=r.count>=r.max,d=r.max>1?`${r.label} - ${r.count}/${r.max} levels`+(r.count>0?`, ${r.price} pts spent`:"")+(s?"":`; next level ${r.nextPrice} pts`):`${r.label} - ${r.price||r.nextPrice} pts`;return v.jsxs(oA,{$gold:!0,title:d,children:[v.jsx(lA,{children:v.jsx(sA,{children:r.label})}),v.jsx(od,{$ink:Br.enh,title:"Remove a level",disabled:r.count<=0,onClick:()=>this.step(-1),children:"−"}),v.jsx(pC,{ref:this.wheelRef,$ink:Br.enh,type:"text",value:r.count,onChange:g=>this.onInput(g)}),v.jsx(od,{$ink:Br.enh,title:r.count>=r.max?"Already at the maximum":`Add a level (${r.nextPrice} pts)`,disabled:r.count>=r.max,onClick:()=>this.step(1),children:"+"}),v.jsx(TA,{$spent:s,title:s?`Fully bought - ${r.price} pts`:"Cost of the next level",children:s?`${r.price}p`:`${r.nextPrice}p`})]})}}class RA extends Ze.Component{render(){const{rows:r,onChange:s}=this.props;if(!r||r.length===0)return null;const d=r.reduce((g,b)=>g+(b.count>0?b.price:0),0);return v.jsxs(Nn.Fragment,{children:[v.jsx(uA,{children:"✦ ENHANCEMENTS"}),v.jsxs(Ax,{$ink:Br.enh,children:[r.map(g=>v.jsx(kA,{row:g,onChange:s},g.enhID)),d>0&&v.jsxs(EA,{children:["Refits: ",d," pts"]})]})]})}}const DA=D.div`
    display: flex;
    flex-direction: column;
    margin-top: 0px;
    width: 100%;
...
`;class PC extends Ze.Component{render(){const{ship:r,hideHitChart:s,tightBottom:d,compactText:g}=this.props,b=!!r.mine||window.gamedata&&typeof gamedata.isTerrain=="function"&&gamedata.isTerrain(r.shipSizeClass,r.userid),S=!!r.flight||b;var y=new Array,T=new Array,$=new Array;r.notes&&(y=r.notes.split("<br>")),r.hitChart&&!s&&NC(r).forEach(function(J){T[J.name]=J.entries.map(function(xe){return xe.name+" "+xe.chance+"%"}).join(", ")}),r.enhancementTooltip!=""&&($=r.enhancementTooltip.split("<br>"));let O={};if(!r.flight&&r.hasAttached&&Object.keys(r.hasAttached).length>0){const J={1:"Forward",2:"Aft",3:"Port",31:"Port-Forward",32:"Port-Aft",4:"Starboard",41:"Starboard-Forward",42:"Starboard-Aft"};for(let xe in r.hasAttached){let Pe=r.hasAttached[xe],de=J[Pe]||"Unknown";O[de]||(O[de]=0),O[de]++}}let P=r.offensivebonus;r.flight&&gamedata.areMinesPresent&&(r.minesweeper?P-=window.ew.getDetectMEW(r):P-=window.ew.getDetectMEW(r)*2);var _=0,V=!0;if(r.mine){var N=shipManager.systems.getSystemByName(r,"mineStealth");N&&!N.isMineRevealed(r)&&(V=!1,T=new Array,y=["No details known, scan with OEW to identify."],$=new Array)}return v.jsxs(oj,{$tightBottom:d,$compactText:g,children:[r.flight&&V&&v.jsxs(en,{children:[v.jsx(yr,{children:"Offensive bonus: "}),P*5]},_++),r.flight&&V&&v.jsxs(en,{children:[v.jsx(yr,{children:"Armor (F/S/A): "}),shipManager.systems.getFlightArmour(r)]},_++),r.flight&&V&&v.jsxs(en,{children:[v.jsx(yr,{children:"Profile - Front/Side: "}),r.forwardDefense*5,"/",r.sideDefense*5]},_++),r.flight&&V&&v.jsxs(en,{children:[v.jsx(yr,{children:"Thrust per turn: "}),r.freethrust]},_++),r.flight&&V&&v.jsx(en,{children:" "},_++),Object.keys(y).length>0&&v.jsxs(en,{children:[v.jsx(yr,{children:"NOTES:"})," "]},_++),Object.keys(y).length>0&&Object.keys(y).map(J=>v.jsx(en,{children:y[J]},_++)),Object.keys(y).length>0&&v.jsx(en,{children:" "},_++),Object.keys(T).length>0&&v.jsxs(en,{children:[v.jsx(yr,{children:"HIT CHART:"})," "]},_++),Object.keys(T).length>0&&Object.keys(T).map(J=>v.jsxs(en,{children:[v.jsxs(yr,{children:[J,": "]}),T[J]]},_++)),Object.keys(T).length>0&&v.jsx(en,{children:" "},_++),Object.keys(O).length>0&&v.jsxs(en,{children:[v.jsx(yr,{children:"UNITS ATTACHED:"})," "]},_++),Object.keys(O).length>0&&Object.keys(O).map(J=>v.jsxs(en,{children:[v.jsxs(yr,{children:[J,": "]}),O[J]]},_++)),Object.keys(O).length>0&&v.jsx(en,{children:" "},_++),S&&r.enhancementTooltip!=""&&V&&v.jsxs(en,{children:[v.jsx(yr,{children:"ENHANCEMENTS:"})," "]},_++),S&&r.enhancementTooltip!=""&&V&&Object.keys($).map(J=>v.jsx(en,{children:$[J]},_++)),S&&r.enhancementTooltip!=""&&V&&v.jsx(en,{children:" "},_++)]})}}const ld=D(bx)`
    /*font-size: 12px;*/
	font-size: 13px;
`,FC=D(xx)`
    position: absolute;
...
`,sj=D.span`
    color: #C6E2FF;
`;class uj extends Ze.Component{render(){const{ship:r,selectedShip:s,system:d,boundingBox:g}=this.props;if(d instanceof Ship||d===r){var b=r.shipClass,S=r.name;if(d.flight&&(b=d.systems[1].displayName),r.mine){var y=shipManager.systems.getSystemByName(r,"mineStealth");y&&!y.isMineRevealed(r)&&(b="Mine",S="Mine")}return v.jsxs(FC,{ship:!0,position:HC(g),children:[v.jsxs(ld,{children:[v.jsx(sj,{children:S})," - ",b]}),v.jsx(PC,{ship:r})]})}var T=new Array;d.data.Special&&d.data.Special!=""&&(T=d.data.Special.split("<br>"));var $="Special",O=0;let P=r.offensivebonus;r.flight&&gamedata.areMinesPresent&&(r.minesweeper?P-=window.ew.getDetectMEW(r):P-=window.ew.getDetectMEW(r)*2);var _=d.displayName,V=d.firingModes?d.firingModes[d.firingMode]:null,N=null;d.name==="ShadowFighterBomb"&&window.weaponManager&&typeof weaponManager.shadowFighterBombPool=="function"&&(N=weaponManager.shadowFighterBombPool(r,d,!0));let J=!1;if(r.mine){var y=shipManager.systems.getSystemByName(r,"mineStealth");y&&!y.isMineRevealed(r)&&(J=!0,_="Mine",T=["No details known, scan with OEW to identify."])}return v.jsxs(FC,{position:HC(g),children:[v.jsx(ld,{children:_}),!r.flight&&!J&&$u("Structure",d.maxhealth-damageManager.getDamage(r,d)+"/"+d.maxhealth),!r.flight&&!J&&$u("Armor",shipManager.systems.getArmour(r,d)),r.flight&&!J&&$u("Offensive bonus",fj(d,P*5)),d.firingModes&&!J&&$u("Firing mode",V),d.missileArray&&Object.keys(d.missileArray).length>0&&!J&&$u("Ammo Amount",d.missileArray[d.firingMode].amount),!J&&Object.keys(d.data).map((xe,Pe)=>xe!=$&&!(xe==="Ammunition"&&(d.name==="GrapplingClaw"||d.name==="Marines"))&&$u(xe,pj(d,xe),"data"+Pe)),N!==null&&$u("Fighters available",N),Object.keys(T).length>0&&v.jsxs(en,{children:[v.jsx(yr,{children:"Special: "})," "]},`special-${O++}`),Object.keys(T).length>0&&Object.keys(T).map(xe=>v.jsx(en,{children:T[xe]},`special-${O++}`)),(Object.keys(d.critData).length>0||d.criticals&&d.criticals.length>0)&&!J&&dj(d),!gamedata.isMyShip(r)&&!J&&(gamedata.gamephase==3||gamedata.gamephase==1)&&gamedata.waiting==!1&&gamedata.selectedSystems.length>0&&s&&BC(r,s,d),gamedata.isMyShip(r)&&!J&&gamedata.rules&&gamedata.rules.friendlyFire===1&&(gamedata.gamephase==3||gamedata.gamephase==5||gamedata.gamephase==1)&&gamedata.waiting==!1&&gamedata.selectedSystems.length>0&&s&&BC(r,s,d),gamedata.isMyShip(r)&&!J&&d.weapon&&weaponManager.hasFiringOrder(r,d)&&cj(r,d)]})}}const BC=(o,r,s)=>weaponManager.canCalledshot(o,s,r)?[v.jsx(ld,{children:"Called shot"},"calledHeader")].concat(gamedata.selectedSystems.map((d,g)=>{if(weaponManager.isOnWeaponArc(r,o,d))if(weaponManager.checkIsInRange(r,o,d)){var b=d.firingMode;return b=d.firingModes[b],s.id!=null&&!weaponManager.canWeaponCall(d)?v.jsxs(en,{children:[v.jsx(yr,{children:d.displayName}),": Cannot Called Shot"]},`called-${g}`):v.jsxs(en,{children:[v.jsx(yr,{children:d.displayName})," - Approx:  ",weaponManager.calculateHitChange(r,o,d,s.id).hitChance,"%"]},`called-${g}`)}else return v.jsxs(en,{children:[v.jsx(yr,{children:d.displayName}),": Not in Range"]},`called-${g}`);else return v.jsxs(en,{children:[v.jsx(yr,{children:d.displayName}),": Not in Arc"]},`called-${g}`)})):[v.jsx(ld,{children:"Called shot"},"calledHeader")].concat(v.jsx(en,{children:"Cannot Target"},"cannotTarget")),cj=(o,r)=>{var s=weaponManager.getCalledShotInfo(o,r);return s?[v.jsx(IC,{},"calledShotDivider"),v.jsx(ld,{children:"Called Shot"},"calledShotHeader"),v.jsxs(en,{children:[v.jsx(yr,{children:"Target: "}),s.targetSystem.displayName," (Id: ",s.targetSystem.id,") on ",s.targetShip.name]},"calledShotTarget")]:null},dj=o=>{const r=Object.keys(o.critData).length>0?Object.keys(o.critData):[...new Set((o.criticals||[]).map(s=>s.phpclass))];return r.length===0?null:[v.jsx(IC,{},"critDivider"),v.jsx(ld,{children:"Criticals"},"criticalHeader")].concat(r.map(s=>{let d=0,g=0;var b=0,S=0,y=!1,T="";b=0,S=0,y=!1,T="";for(const O in o.criticals)o.criticals[O].phpclass==s&&o.criticals[O].turn<=gamedata.turn&&(o.criticals[O].turnend==0||o.criticals[O].turnend>=gamedata.turn)&&(d++,g+=parseInt(o.criticals[O].param,10)||0,d==1&&(b=o.criticals[O].turnend,S=o.criticals[O].turnend,y=o.criticals[O].turnend==0),o.criticals[O].turnend>0?(o.criticals[O].turnend>S&&(S=o.criticals[O].turnend),(o.criticals[O].turnend<b||b==0)&&(b=o.criticals[O].turnend)):y=!0);if(b>0&&(T=" (until end of turn "+b,y?T=T+"+":S>b&&(T=T+"-"+S),T=T+")"),d>=1&&UC[s]){const O=UC[s](g);return v.jsxs(en,{children:[O," ",T]},`critical-${s}`)}const $=o.critData[s]||lj[s]||s;return d>1?v.jsxs(en,{children:["(",d," x) ",$," ",T]},`critical-${s}`):d==1?v.jsxs(en,{children:[$," ",T]},`critical-${s}`):null}))},fj=(o,r)=>typeof o.adjustOffensiveBonusDisplay=="function"?o.adjustOffensiveBonusDisplay(r):r,pj=(o,r)=>typeof o.adjustDataValueDisplay=="function"?o.adjustDataValueDisplay(r,o.data[r]):o.data[r],$u=(o,r,s)=>{if(typeof r=="string"&&r.indexOf("<br>")!==-1){const d=r.split("<br>");return v.jsxs(en,{children:[v.jsxs(yr,{children:[o,": "]}),d.map((g,b)=>v.jsxs(Ze.Fragment,{children:[b>0&&v.jsx("br",{}),g]},b))]},s)}return v.jsxs(en,{children:[v.jsxs(yr,{children:[o,": "]}),r]},s)},HC=o=>{const r={};return o.top>window.innerHeight/2?r.bottom=window.innerHeight-o.top:r.top=o.top+o.height,o.left>window.innerWidth/2?r.right=window.innerWidth-o.right:r.left=o.left+o.width,r};D(bx)`
    font-size: 12px;
`;const hj=D(xx)`
    position: absolute;
    z-index: 20000;
...
`,Aj=D.span`
    ...
    `}
`;class jj extends Ze.Component{componentWillUnmount(){this.activeHighlight&&window.webglScene&&(window.uiEvents.relay("EwTargetHighlight",{shipId:this.props.ship.id,targetId:this.activeHighlight.targetId,type:this.activeHighlight.type,active:!1}),this.activeHighlight=null),this.activeRangeOverlay&&this.setRangeOverlay(this.activeRangeOverlay,!1)}setRangeOverlay(r,s){window.webglScene&&(window.uiEvents.relay("EwRangeHover",{shipId:this.props.ship.id,type:r,active:s}),this.activeRangeOverlay=s?r:null)}onTargetClick(r,s){s.stopPropagation(),window.webglScene&&(shipManager.shouldBeHidden(r)||window.uiEvents.relay("ScrollToShip",{shipId:r.id}))}setTargetHighlight(r,s,d){window.webglScene&&(window.uiEvents.relay("EwTargetHighlight",{shipId:this.props.ship.id,targetId:r.id,type:s,active:d}),this.activeHighlight=d?{targetId:r.id,type:s}:null)}render(){const{ship:r}=this.props;return v.jsxs(Mj,{children:[v.jsx(Oj,{children:"Electronic Warfare"}),_j(r,this),Lj(r,this)]})}}const _j=(o,r)=>{let s=[];const d=!!window.webglScene,g=$=>d?{$hoverable:!0,onMouseEnter:()=>r.setRangeOverlay($,!0),onMouseLeave:()=>r.setRangeOverlay($,!1)}:{};s.push(v.jsxs(ud,{children:[v.jsx(cd,{$color:sd("DEW"),children:"DEW"}),v.jsx(dd,{children:to(ew.getDefensiveEW(o))})]},`dew-scs-${o.id}`));var b=Math.max(0,ew.getCCEW(o)-ew.getDistruptionEW(o));b>0&&s.push(v.jsxs(ud,{children:[v.jsx(cd,{$color:sd("CCEW"),children:"CCEW"}),v.jsx(dd,{children:to(b)})]},`ccew-scs-${o.id}`));let S=ew.getBDEW(o)*.25,y=ew.getDetectSEW(o),T=ew.getDetectMEW(o);return shipManager.hasSpecialAbility(o,"ConstrainedEW")&&(S=ew.getBDEW(o)*.2),S&&s.push(v.jsxs(ud,{...g("BDEW"),children:[v.jsx(cd,{$color:sd("BDEW"),children:"BDEW"}),v.jsx(dd,{children:to(S)})]},`bdew-scs-${o.id}`)),T&&s.push(v.jsxs(ud,{...g("MDEW"),children:[v.jsx(cd,{$color:sd("Detect Mines"),children:"Detect Mines"}),v.jsx(dd,{children:to(T)})]},`DetectMEW-scs-${o.id}`)),y&&s.push(v.jsxs(ud,{children:[v.jsx(cd,{$color:sd("Detect Stealth"),children:"Detect Stealth"}),v.jsx(dd,{children:to(y)})]},`DetectSEW-scs-${o.id}`)),s},Lj=(o,r)=>{const s=!!window.webglScene;return o.EW.filter(d=>d.turn===gamedata.turn).filter(d=>d.type==="OEW"||d.type==="DIST"||d.type==="SOEW"||d.type==="SDEW").map(d=>{const g=gamedata.getShip(d.targetid);return v.jsxs(ud,{$target:!0,children:[v.jsxs($j,{children:[v.jsx(cd,{$color:sd(d.type,o),children:d.type}),v.jsx(Aj,{$interactive:s,title:void 0,onClick:s?r.onTargetClick.bind(r,g):void 0,onMouseEnter:s?()=>r.setTargetHighlight(g,d.type,!0):void 0,onMouseLeave:s?()=>r.setTargetHighlight(g,d.type,!1):void 0,children:g.name})]}),v.jsx(dd,{children:zj(d,o)})]},`${d.type}-scs-${o.id}-${d.targetid}`)})},zj=(o,r)=>{switch(o.type){case"SDEW":if(shipManager.hasSpecialAbility(r,"ConstrainedEW")){let s=o.amount*.333;return s=Math.round(s*3)/3,to(s)}else return to(o.amount*.5);case"DIST":return shipManager.hasSpecialAbility(r,"ConstrainedEW")?to(o.amount/4):to(o.amount/3);case"OEW":return to(Math.max(0,o.amount-ew.getDistruptionEW(r)));default:return to(o.amount)}},to=o=>Math.round(o*100)/100,Jg=()=>!!window.gamedata&&window.gamedata.gamephase===-2,Nj=D.div`
    position: relative;
    width: 114px;
    height: 150px;
    background-color: black;
...
`,r_=D.span`
    ...
    color: ${H.colors.text};
    flex-shrink: 0;
`,i_=(o,r)=>v.jsxs(e_,{children:[v.jsx(t_,{children:r.name}),[...r.entries].sort((s,d)=>d.chance-s.chance).map((s,d)=>v.jsxs(n_,{children:[v.jsx("span",{children:s.name}),v.jsxs(r_,{children:[s.chance,"%"]})]},`hitchart-${o.id}-${r.location}-${d}`))]},`hitchart-${o.id}-${r.location}`);class a_ extends Ze.Component{render(){const{ship:r}=this.props,s=NC(r);if(s.length===0)return null;const d={};s.forEach(T=>{d[T.location]=T});const g=T=>T.filter($=>d[$]).map($=>i_(r,d[$])),b=g(qj),S=g(Xj),y=g(Zj);return v.jsxs(Jj,{children:[b.length>0&&v.jsx(a0,{$side:!0,children:b}),S.length>0&&v.jsx(a0,{children:S}),y.length>0&&v.jsx(a0,{$side:!0,children:y})]})}}const o_=o=>o.split(" ").map(r=>r.charAt(0).toUpperCase()+r.slice(1)).join(" "),l_=o=>{const r=[];if(!o||o.flight)return r;const s=o.fighters||{};if(Object.keys(s).length>0){const g={};if(shipManager.systems.shipHasRestrictedHangar(o)){const b=shipManager.systems.getReservedFighterComposition(o);for(let S=0;S<b.length;S++){const y=b[S].category;g[y]||(g[y]=[]);const T=g[y];let $=!1;for(let O=0;O<T.length;O++)if(T[O].phpclass===b[S].phpclass){T[O].count+=b[S].count,$=!0;break}$||T.push({category:b[S].category,phpclass:b[S].phpclass,displayName:b[S].displayName,count:b[S].count,isGroup:b[S].isGroup})}}for(const b in s){const S=s[b],y=o_(b),T=g[b];if(T&&(b==="heavy"||b==="medium"||b==="light")){let $=S;for(let O=0;O<T.length;O++){const P=Math.min(T[O].count,$);P<=0||(T[O].isGroup?r.push(P+" "+T[O].displayName+"s"):r.push(P+" "+T[O].displayName+" "+y+" Fighters"),$-=P)}$>0&&r.push($+" "+y+" Fighters");continue}if(b==="normal")r.push(S+" Fighters");else if(b==="superheavy"||b==="heavy"||b==="medium"||b==="light"||b==="ultralight")r.push(S+" "+y+" Fighters");else{if(b==="shuttles"||b==="minesweeping shuttles"||b==="cargo shuttles"||b==="lifeboats"||b==="medical shuttles"||b==="presidential shuttle"||b==="yacht")continue;r.push(S+" "+y)}}}const d=shipManager.systems.getDefaultShuttleComposition(o);for(let g=0;g<d.length;g++)r.push(d[g].count+" "+d[g].type);return r},s_=D.div`
    box-sizing: border-box;
    display: flex;
    flex-direction: column;
    gap: 4px;
...
`,f_=D.div`
    ...
    line-height: 1.4;
    color: ${H.colors.enhText};
`,l0=o=>typeof o=="number"?o.toFixed(2):o,ZC=(o,r)=>o*5+"/"+r*5,em=(o,r)=>o+" ("+l0(r)+")",p_=o=>{const r=window.shipManager;if(!r)return null;const s={},d=r.systems?r.systems.getSystemByName(o,"CnC"):null,g=d&&r.criticals?r.criticals.hasCritical(d,"ProfileIncreased"):0;s.profile=ZC(o.forwardDefense+g,o.sideDefense+g),s.profileChanged=g!==0;const b=o.iniativeadded||0;s.initiative=(o.iniativebonus||0)+b,s.initiativeChanged=b!==0;const S=r.movement;if(S&&typeof S.getTurnCost=="function"&&o.movement&&o.movement.length>0){const y=S.getSpeed(o),T=S.getDockedLcvTurnSurcharge(o),$=S.getTurnDelayCost(o);let O=S.getTurnCost(o);o.submarine&&S.isGoingBackwards(o)&&(O=O*1.33);const P=Math.max(1,Math.ceil(y*O))+T,_=Math.ceil(y*$)+T;s.turnCost=em(P,O),s.turnDelay=em(_,$),s.turnCostChanged=s.turnCost!==em(Math.max(1,Math.ceil(y*o.turncost)),o.turncost),s.turnDelayChanged=s.turnDelay!==em(Math.ceil(y*o.turndelaycost),o.turndelaycost)}return s},JC=({ship:o,live:r,bare:s})=>{const d=!o.base,g=r?p_(o):null;return v.jsxs(c_,{$bare:s,children:[!s&&v.jsxs(d_,{children:[v.jsxs(qC,{children:[v.jsx("i",{}),v.jsx("i",{}),v.jsx("i",{})]}),"Ship Stats"]}),d&&v.jsxs(Da,{children:[v.jsx(Ma,{children:"Turn cost"}),v.jsx(Oa,{$changed:!!(g&&g.turnCostChanged),children:g&&g.turnCost?g.turnCost:l0(o.turncost)})]}),d&&v.jsxs(Da,{children:[v.jsx(Ma,{children:"Turn delay"}),v.jsx(Oa,{$changed:!!(g&&g.turnDelayChanged),children:g&&g.turnDelay?g.turnDelay:l0(o.turndelaycost)})]}),d&&v.jsxs(Da,{children:[v.jsx(Ma,{children:"Accel/decel"}),v.jsx(Oa,{children:o.accelcost})]}),d&&v.jsxs(Da,{children:[v.jsx(Ma,{children:"Pivot"}),v.jsx(Oa,{children:o.pivotcost})]}),d&&v.jsxs(Da,{children:[v.jsx(Ma,{children:"Roll"}),v.jsx(Oa,{children:o.rollcost})]}),v.jsxs(Da,{children:[v.jsx(Ma,{children:"Profile - Front / Side"}),v.jsx(Oa,{$changed:!!(g&&g.profileChanged),children:g?g.profile:ZC(o.forwardDefense,o.sideDefense)})]}),d&&v.jsxs(Da,{children:[v.jsx(Ma,{children:"Initiative"}),v.jsx(Oa,{$changed:!!(g&&g.initiativeChanged),children:g?g.initiative:o.iniativebonus})]})]})},h_=({ship:o})=>{const r=s0(o.enhancementTooltip);return r.length===0?null:v.jsx(f_,{children:v.jsxs(vp,{$gold:!0,children:[v.jsx(XC,{children:"Enhancements"}),r.map((s,d)=>v.jsx(yp,{children:s},`enh-${d}`))]})})},s0=o=>(o||"").split(/<br\s*\/?>/i).map(r=>r.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim()).filter(Boolean);class u0 extends Ze.Component{render(){const{ship:r,full:s,grid:d,hideEnhancements:g}=this.props,b=l_(r),S=s0(r.notes),y=g?[]:s0(r.enhancementTooltip),T=[];if(r.limited&&r.limited!=0&&T.push("Limited: "+r.limited+"%"),r.variantOf){const P=r.occurence?r.occurence.charAt(0).toUpperCase()+r.occurence.slice(1)+" ":"";T.push(P+"variant of "+r.variantOf)}r.isd&&T.push("In-Service (ISD): "+r.isd);let $=null;r.unofficial==="S"?$="Semi-Custom":r.unofficial&&($="Custom");const O=S.length>0||T.length>0||$;return v.jsxs(s_,{$full:s,$grid:d,children:[r.flight&&v.jsxs(vp,{children:[v.jsx(o0,{children:"Flight Stats"}),v.jsxs(Da,{children:[v.jsx(Ma,{children:"Armor F/S/A"}),v.jsx(Oa,{children:shipManager.systems.getFlightArmour(r)})]}),v.jsxs(Da,{children:[v.jsx(Ma,{children:"Off. bonus"}),v.jsx(Oa,{children:r.offensivebonus*5})]}),v.jsxs(Da,{children:[v.jsx(Ma,{children:"Profile - Front / Side"}),v.jsxs(Oa,{children:[r.forwardDefense*5,"/",r.sideDefense*5]})]}),v.jsxs(Da,{children:[v.jsx(Ma,{children:"Thrust"}),v.jsx(Oa,{children:r.freethrust})]}),v.jsxs(Da,{children:[v.jsx(Ma,{children:"Initiative"}),v.jsx(Oa,{children:r.iniativebonus})]})]}),b.length>0&&v.jsxs(vp,{children:[v.jsx(o0,{children:"Hangar Capacity"}),b.map((P,_)=>v.jsx(yp,{children:P},`comp-${_}`))]}),O&&v.jsxs(vp,{children:[v.jsx(o0,{children:"Notes"}),S.map((P,_)=>v.jsx(yp,{children:P},`note-${_}`)),T.map((P,_)=>v.jsx(yp,{children:P},`meta-${_}`)),$&&v.jsx(u_,{children:$})]}),y.length>0&&v.jsxs(vp,{$gold:!0,children:[v.jsx(XC,{children:"Enhancements"}),y.map((P,_)=>v.jsx(yp,{children:P},`enh-${_}`))]})]})}}const xp=D.div`
    display: flex;
    flex-direction: column;
    position: absolute;
...
`;class aL extends Ze.Component{constructor(r){super(r),this.state={error:null}}static getDerivedStateFromError(r){return{error:r}}componentDidCatch(r,s){const d=this.props.ship;console.error("Ship window render failed for",d&&(d.name||d.shipClass),r,s)}render(){if(this.state.error){const r=this.props.ship;return v.jsxs(rL,{children:[v.jsxs("span",{children:[r&&(r.name||r.shipClass)||"Ship"," — window failed to render (see console)"]}),v.jsx(iL,{onClick:()=>window.uiEvents.relay("CloseShipWindow",{ship:r}),children:"✕"})]})}return this.props.children}}class oL extends Ze.Component{render(){const{ships:r}=this.props;return v.jsx(nL,{children:r.map(s=>v.jsx(aL,{ship:s,children:v.jsx(__,{ship:s})},`shipwindow-${s.userid}-${s.id}`))})}}const lL=D.div`
    position: absolute;
    z-index: 20000;
    ${o=>Object.keys(o.$position).reduce((r,s)=>r+`
`+s+":"+o.$position[s]+"px;","")}
...
`,wL=D.div`
    ...
    &:hover { background: ${qe.line}; color: #ffffff; }
`,SL=o=>{const r={};return o.top>window.innerHeight/2?r.bottom=window.innerHeight-o.top:r.top=o.top+o.height,o.left>window.innerWidth/2?r.right=window.innerWidth-o.right:r.left=o.left,r};class CL extends Ze.Component{constructor(r){super(r),this.wheelRefs={}}wheelRef(r){return this.wheelRefs[r]||(this.wheelRefs[r]=fp(s=>this.step(r,s.deltaY<0?1:-1))),this.wheelRefs[r]}maxHealth(){return battleDamage.mineMaxHealth(this.props.ship)}setRemaining(r,s){const{ship:d}=this.props,g=this.maxHealth();let b=parseInt(s,10);isNaN(b)&&(b=g),b=Math.max(1,Math.min(g,b)),battleDamage.setMine(d,r,{d:g-b}),this.refresh()}step(r,s){this.setRemaining(r,battleDamage.mineHealth(this.props.ship,r)+s)}onInput(r,s){const d=String(s.target.value).replace(/[^0-9]/g,"");this.setRemaining(r,d===""?0:parseInt(d,10))}propagate(){const{ship:r}=this.props,s=battleDamage.mineCount(r),d=battleDamage.getEntry(r,battleDamage.KIND_MINE,1);for(let g=2;g<=s;g++)battleDamage.setWholeEntry(r,battleDamage.KIND_MINE,g,d);this.refresh()}refresh(){const{ship:r}=this.props;battleDamage.applyToShip(r),window.shipWindowManagerReact&&window.shipWindowManagerReact.update(),window.gamedata&&typeof gamedata.refreshFleetRow=="function"&&gamedata.refreshFleetRow(r),this.forceUpdate()}render(){const{ship:r,boundingBox:s}=this.props,d=battleDamage.mineCount(r),g=this.maxHealth();if(!d||g<2)return null;const b=battleDamage.mineSummary(r),S=[];for(let y=1;y<=d;y++){const T=battleDamage.mineHealth(r,y);S.push(v.jsxs(vL,{children:[v.jsxs(yL,{children:["Mine ",y]}),v.jsx(gE,{title:"More damage",disabled:T<=1,onClick:()=>this.step(y,-1),children:"−"}),v.jsx(bL,{ref:this.wheelRef(y),type:"text",value:T,onChange:$=>this.onInput(y,$)}),v.jsx(gE,{title:"Repair",disabled:T>=g,onClick:()=>this.step(y,1),children:"+"}),v.jsxs(xL,{children:["/ ",g]})]},`mne-${y}`))}return v.jsxs(gL,{$position:SL(s),onClick:y=>y.stopPropagation(),children:[v.jsx(hC,{$sticky:!0,children:"Mine Damage"}),v.jsxs(mL,{children:[b.remaining," / ",b.total," structure"]}),S,d>1&&v.jsx(wL,{title:"Copy Mine 1's damage to every mine in this purchase",onClick:()=>this.propagate(),children:"Apply Mine 1 to all"})]})}}class EL{constructor(r){this.parentElement=r,this.roots=new Map}getRoot(r){const s=jQuery(r,this.parentElement)[0];return s?(this.roots.has(s)||this.roots.set(s,tx(s)),this.roots.get(s)):null}unmountRoot(r){const s=jQuery(r,this.parentElement)[0];s&&this.roots.has(s)&&(this.roots.get(s).unmount(),this.roots.delete(s))}EwButtons(r){const s=this.getRoot("#showEwButtons");s&&s.render(v.jsx(ZM,{...r}))}FullScreen(r){const s=this.getRoot("#fullScreen");s&&s.render(v.jsx(GM,{...r}))}Surrender(r){const s=this.getRoot("#surrender");s&&s.render(v.jsx(QM,{...r}))}PlayerSettings(r){const s=this.getRoot("#playerSettings");s&&s.render(v.jsx(jM,{...r}))}showShipThrustUI(r){const s=this.getRoot("#shipThrust");s&&s.render(v.jsx(BM,{...r}))}hideShipThrustUI(){this.unmountRoot("#shipThrust")}showWeaponList(r){const s=this.getRoot("#weaponList");s&&s.render(v.jsx(aj,{...r}))}hideWeaponList(){this.unmountRoot("#weaponList")}showSystemInfo(r){const s=this.getRoot("#systemInfoReact");s&&s.render(v.jsx(uj,{...r}))}hideSystemInfo(){this.unmountRoot("#systemInfoReact")}showSystemInfoMenu(r){const s=this.getRoot("#systemInfoReact");s&&s.render(v.jsx(gj,{...r}))}hideSystemInfoMenu(){this.unmountRoot("#systemInfoReact")}canShowSystemInfoMenu(r,s){return Gx(r,s)}showFighterDamageMenu(r){const s=this.getRoot("#systemInfoReact");s&&s.render(v.jsx(hL,{...r}))}showMineDamageMenu(r){const s=this.getRoot("#systemInfoReact");s&&s.render(v.jsx(CL,{...r}))}renderShipWindows(r){const s=this.getRoot("#shipWindowsReact");s&&s.render(v.jsx(oL,{...r}))}}window.UIManager=EL});
