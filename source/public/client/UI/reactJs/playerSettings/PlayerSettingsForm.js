    ...
    render() {
        return (<Backdrop>
            <SubContainer>
                ...
                <InputAndLabel label={"Key to toggle LINE OF SIGHT indicators"} onChange={() => { }} onKeydown={this.getOnKeyDown.call(this, "ToggleLoS")} value={this.getKey.call(this, "ToggleLoS")} />                                                                                                
