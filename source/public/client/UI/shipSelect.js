...
window.shipSelectList = {
    ...
    haveToShowList: function haveToShowList(ship, event) {
    ...
    showList: function showList(ship) {
                ...
                if (gamedata.isEnemy(selectedShip, listship)) {
                    ...
                    if (ew.checkInELINTDistance(selectedShip, listship, 30)) {
                        if (ew.getEWByType("BDEW", selectedShip) == 0) {
                            ...
                            if (jammer != null && shipManager.systems.getOutput(listship, jammer) > 0 && !shipManager.systems.isDestroyed(listship, jammer)) {
    ...
    onListClicked: function onListClicked(e) {
        shipSelectList.remove();
