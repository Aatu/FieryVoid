; (function () {
		...
		if (g instanceof THREE.BufferGeometry) {
			...
			if (positions) {
				for (var j = 0; j < positions.count; j++) {
					var v = new THREE.Vector3().fromBufferAttribute(positions, j);
					var c = j / positions.count;
	...
	function MeshLineMaterial(parameters) {
		...
		if (parameters.blending === null || parameters.blending === undefined) {
