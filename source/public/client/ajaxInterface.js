...
window.ajaxInterface = {
  ...
  getShipsForFaction: function getShipsForFaction(
    factionRequest,
    getFactionShipsCallback
  ) {
    $.ajax({
      type: "POST",
  ...
  construcGamedata: function construcGamedata() {
    ...
    for (var i in gamedata.ships) {
      ...
      if (gamedata.isMyShip(ship)) {
        newShip.movement = ship.movement
