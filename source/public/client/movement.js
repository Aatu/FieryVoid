...
//					continue;
    ...
    doForcedPivot: function (ship) {
        ...
        var alreadyDone = ship.movement.some(function(inspectedMovement) {
            console.log("movement", inspectedMovement.type, inspectedMovement.forced, inspectedMovement.turn === gamedata.turn, inspectedMovement.type === name, inspectedMovement.forced === true,  inspectedMovement.facing === facing);
