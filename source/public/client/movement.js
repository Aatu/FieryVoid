...
//					continue;
    ...
    doForcedPivot: function (ship) {
        ...
        var alreadyDone = ship.movement.some(function(inspectedMovement) {
            console.log(inspectedMovement.turn === gamedata.turn , inspectedMovement.type === name , inspectedMovement.forced === true , inspectedMovement.facing === facing, inspectedMovement.facing, facing);
            return inspectedMovement.turn === gamedata.turn && inspectedMovement.type === name && inspectedMovement.forced === true && inspectedMovement.facing === facing;
        });
