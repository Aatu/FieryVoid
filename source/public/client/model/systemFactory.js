...
window.SystemFactory = {
    createSystemsFromJson: function createSystemsFromJson(systemsJson, ship) {
        var systems = Array();
    ...
    createSystemFromJson: function createSystemFromJson(systemJson, ship) {
        if (systemJson.fighter) return new Fighter(systemJson, ship);
