...
window.windowEvents = {
    ...
    botElementMouseOver: function botElementMouseOver(e) {
        $(this).addClass("mouseover");
    },

    botElementMouseOut: function botElementMouseOut(e) {
        $(this).removeClass("mouseover");
    },

    onKeyUp: function onKeyUp(e) {

        if (windowEvents.chatfocus) return;
...
window.zooming = {
    ...
    mouseWheel: function mouseWheel(e) {
        ...
        //     console.log("ding");
        if (gamedata.effectsDrawing) return;
        ...
        if (wheelData < 0) zooming.wheelzoom--;else zooming.wheelzoom++;

        if (zooming.wheeltimer == null && zooming.zoominprogress == false) zooming.wheeltimer = setTimeout(zooming.wheelCallback, 100);

        return cancelEvent(e);
    },

    wheelCallback: function wheelCallback() {
    ...
    zoomin: function zoomin() {
        zooming.zoom(false, Math.round(gamedata.gamewidth / 2), Math.round(gamedata.gameheight / 2), 1);
    },
    zoomout: function zoomout() {
        zooming.zoom(true, Math.round(gamedata.gamewidth / 2), Math.round(gamedata.gameheight / 2), 1);
    },

    zoom: function zoom(out, cX, cY, multiply) {
...
window.scrolling = {
    ...
    scrollToShip: function scrollToShip(ship) {
