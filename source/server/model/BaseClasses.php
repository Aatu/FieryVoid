...
class PlayerSlot
{
    ...
    public function __construct($playerid, $slot, $team, $lastturn, $lastphase, $name, $points, $depx, $depy, $deptype, $depwidth, $depheight, $depavailable, $playername)
    {
...
class DamageEntry
{
    ...
    public function __construct($id, $shipid, $gameid, $turn, $systemid, $damage, $armour, $shields, $fireorderid, $destroyed, $pubnotes, $damageclass = null, $shooterid = null, $weaponid = null)
    {
        $this->id = $id;
        $this->shipid = $shipid;
        $this->gameid = $gameid;
...
class EWentry
{
    ...
    public function __construct($id, $shipid, $turn, $type, $amount, $targetid)
    {
        $this->id = $id;
        $this->shipid = $shipid;
        $this->turn = $turn;
...
class PowerManagementEntry
{
    ...
    public function __construct($id, $shipid, $systemid, $type, $turn, $amount)
    {
        $this->id = (int) $id;
...
class Ballistic
{
    ...
    public function __construct($id, $fireid, $position, $facing, $targetpos, $targetid, $shooterid, $weaponid, $shots)
    {
        $this->id = (int) $id;
