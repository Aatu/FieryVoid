...
class TacGamedata
{
    ...
    public function __construct($id, $turn, $phase, $activeship, $forPlayer, $name, $status, $points, $background, $creator, $gamespace = null, $rules = null)
    {
        $this->setId($id);
        $this->setTurn($turn);
        $this->setPhase($phase);
