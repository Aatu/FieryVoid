...
class Xill extends VreeCapital{
	...
	function __construct($id, $userid, $name,  $slot){
		...
		$thrust = new GraviticThruster(5, 16, 0, 9, 1);
		$thrust->startArc = 300;
		$thrust->endArc = 60;
		...
		$thrust = new GraviticThruster(5, 16, 0, 9, 2);
		$thrust->startArc = 120;
		$thrust->endArc = 240;
		...
		$thrust = new GraviticThruster(5, 16, 0, 9, 3);
		$thrust->startArc = 240;
		$thrust->endArc = 300;
		$thrust->overkillArcStructures = array(31, 32); //overkill spills to whichever Port quarter (Fwd/Aft) is in arc
		...
		$thrust = new GraviticThruster(5, 16, 0, 9, 4);
		$thrust->startArc = 60;
		$thrust->endArc = 120;
		$thrust->overkillArcStructures = array(41, 42); //overkill spills to whichever Stbd quarter (Fwd/Aft) is in arc
