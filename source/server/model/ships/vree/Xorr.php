...
class Xorr extends VreeCapital{
	...
	function __construct($id, $userid, $name,  $slot){
		...
		$this->addLeftFrontSystem(new AntiprotonGun(3, 8, 4, 240, 360));
		$this->addLeftFrontSystem(new Thruster(4, 7, 0, 4, 3));
				
		$this->addLeftAftSystem(new AntiprotonGun(3, 8, 4, 180, 300));
		$this->addLeftAftSystem(new Thruster(4, 7, 0, 4, 3));
		
		$this->addRightFrontSystem(new AntiprotonGun(3, 8, 4, 0, 120));
		$this->addRightFrontSystem(new Thruster(4, 7, 0, 4, 4));
				
		$this->addRightAftSystem(new AntiprotonGun(3, 8, 4, 60, 180));
