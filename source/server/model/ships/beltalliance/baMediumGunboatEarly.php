<?php
class BAMediumGunboatEarly extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addFrontSystem(new BAInterceptorPrototype(2, 4, 1, 270, 90));
        ...
        $this->addAftSystem(new BAInterceptorPrototype(2, 0, 0, 90, 270));
