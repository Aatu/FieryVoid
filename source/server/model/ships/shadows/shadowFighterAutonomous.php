<?php
class ShadowFighterAutonomous extends FighterFlight{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->phpclass = "ShadowFighterAutonomous";
		$this->shipClass = "Medium Fighters (Autonomous)";
		...
		*/
		...
		$this->notes = "Shadow fighters that are not intergrated with a ship, suffer OB and Initiative Penalties.";
