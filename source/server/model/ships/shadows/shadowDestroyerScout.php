<?php
class ShadowDestroyerScout extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "ShadowDestroyerScout";
		...
		*/
		...
		$scanner = new ElintScanner(5, 20, 4, 15);
		...
		//weapons - Forward for visual reasons!
        	$this->addFrontSystem(new PhasingPulseCannon(4, 0, 0, 240, 0));
        	$this->addFrontSystem(new PhasingPulseCannon(4, 0, 0, 0, 120));
