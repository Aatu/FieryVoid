<?php
class CircasianRolassa extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "CircasianRolassa";
        $this->imagePath = "img/ships/EscalationWars/CircasianCairn.png";
			$this->canvasSize = 125; //img has 200px per side
        $this->shipClass = "Rolassa Tender";
			$this->variantOf = "Cairn Carrier";
			$this->occurence = "uncommon";
			$this->unofficial = true;
        $this->isd = 1935;
		$this->fighters = array("light"=>6, "LCVs"=>2);
