<?php
class CircasianKolanisCarrier extends BaseShip{
	...
	$this->faction = "ZEscalation Circasian";
        ...
        $this->shipClass = "Kolanis Carrier";
	...
	$this->isd = 1963;
        ...
        $this->addFrontSystem(new LightPlasma(1, 4, 2, 240, 60));
        $this->addFrontSystem(new EWRocketLauncher(3, 4, 1, 300, 0));
        $this->addFrontSystem(new EWRocketLauncher(3, 4, 1, 0, 60));
		...
		$this->addLeftSystem(new LightParticleBeamShip(1, 2, 1, 240, 0));
		$this->addLeftSystem(new LightParticleBeamShip(1, 2, 1, 180, 300));
        $this->addLeftSystem(new LightParticleCannon(3, 6, 5, 300, 0));
        $this->addLeftSystem(new LightParticleCannon(3, 6, 5, 300, 0));
