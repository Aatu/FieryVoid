<?php
class EpimetheusDeltaAM extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "EpimetheusDeltaAM";
        $this->imagePath = "img/ships/epimetheus.png";
        $this->shipClass = "Epimetheus Jump Cruiser (Delta)";
...
//			$this->canvasSize = 175; //img has 200px per side
        ...
        $this->addLeftSystem(new AmmoMissileRackS(3, 0, 0, 240, 0, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
