<?php
class KitsuneHarasser extends LCV{
	...
	$this->phpclass = "KitsuneHarasser";
	$this->shipClass = "Kitsune Harasser";
			$this->variantOf = "Kitsune Anti-fighter Platform";
			$this->occurence = "common";
	$this->imagePath = "img/ships/Kitsune2.png";
	$this->canvasSize = 90;
	$this->agile = true;
	...
	$this->addFrontSystem(new BallisticTorpedo(3, 5, 6, 300, 60));
