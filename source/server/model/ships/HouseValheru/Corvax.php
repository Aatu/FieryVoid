...
//			$this->occurence = "rare";
		...
		$this->addFrontSystem(new AssaultLaser(4, 6, 6, 315, 45));
		...
		$this->addLeftSystem(new AssaultLaser(4, 6, 6, 225, 360));
		
		$this->addRightSystem(new Thruster(5, 15, 0, 4, 4));
		$this->addRightSystem(new AssaultLaser(4, 6, 6, 0, 135));        
        ...
        $this->addPrimarySystem(new Structure( 6, 39));
