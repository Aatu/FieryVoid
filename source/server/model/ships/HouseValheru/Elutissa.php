<?php
class Elutissa extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $movement){
        ...
        $this->phpclass = "Elutissa";
        $this->imagePath = "img/ships/Elutai3.png";
        $this->shipClass = "Elutissa Support Destroyer";
			$this->variantOf = "Elutai Bombardment Destroyer";
        ...
        $this->addFrontSystem(new AssaultLaser(4, 6, 6, 240, 360));
		$this->addFrontSystem(new AssaultLaser(4, 6, 6, 240, 360));
        $this->addFrontSystem(new AssaultLaser(4, 6, 6, 0, 120));
        $this->addFrontSystem(new AssaultLaser(4, 6, 6, 0, 120));
       
		$this->addAftSystem(new GuardianArray(0, 4, 2, 60, 300));  
        $this->addAftSystem(new AssaultLaser(4, 6, 6, 180, 300));
		$this->addAftSystem(new AssaultLaser(4, 6, 6, 60, 180));
