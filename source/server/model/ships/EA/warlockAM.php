<?php
class WarlockAM extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addLeftSystem(new AmmoMissileRackL(3, 0, 0, 240, 0, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addLeftSystem(new AmmoMissileRackLH(3, 0, 0, 240, 0, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        ...
        $this->addRightSystem(new AmmoMissileRackLH(3, 0, 0, 0, 120, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
