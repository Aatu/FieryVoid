<?php
class HyperionMissileAM extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "HyperionMissileAM";
        ...
        $ammoMagazine = new AmmoMagazine(220); //pass magazine capacity - 20 rounds per launcher, plus reload rack 80
        $this->addPrimarySystem($ammoMagazine); //fit to ship immediately
        $ammoMagazine->addAmmoEntry(new AmmoMissileB(), 220); //add full load of basic missiles
        ...
        $this->addLeftSystem(new AmmoMissileRackS(4, 0, 0, 120, 240, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addLeftSystem(new AmmoMissileRackS(3, 0, 0, 180, 0, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addLeftSystem(new AmmoMissileRackS(4, 0, 0, 300, 60, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
