...
class ArtemisBeta extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addPrimarySystem(new Railgun(5, 9, 6, 240, 0));
        $this->addPrimarySystem(new Railgun(5, 9, 6, 0, 120));
        ...
        $this->addFrontSystem(new Railgun(5, 9, 6, 240, 0));
        $this->addFrontSystem(new Railgun(5, 9, 6, 0, 120));
        ...
        $this->addAftSystem(new Thruster(5, 12, 0, 4, 2));
        $this->addAftSystem(new Railgun(5, 9, 6, 180, 300));
        $this->addAftSystem(new Railgun(5, 9, 6, 60, 180));
