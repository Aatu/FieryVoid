<?php
class HermesFastBeta extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		//Fast Transport is nice and well armed, but not really top priority (might be civilian, too) - hence I'm enabling most defensive option only
