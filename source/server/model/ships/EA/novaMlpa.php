<?php
class NovaMlpa extends BaseShip{
    ...
    function __construct($id, $userid, $name, $movement){
        ...
        $this->addFrontSystem(new Thruster(3, 10, 0, 4, 1));        
        $this->addFrontSystem(new MLPA(4, 9, 5, 300, 0));
        $this->addFrontSystem(new MLPA(4, 9, 5, 300, 0));        
        $this->addFrontSystem(new MLPA(4, 9, 5, 0, 60));
        $this->addFrontSystem(new MLPA(4, 9, 5, 0, 60));
        ...
        $this->addAftSystem(new Thruster(4, 9, 0, 2, 2));
        $this->addAftSystem(new Thruster(4, 9, 0, 2, 2));        
        $this->addAftSystem(new MLPA(3, 9, 5, 180, 300));
        $this->addAftSystem(new MLPA(3, 9, 5, 180, 300));        
        $this->addAftSystem(new MLPA(3, 9, 5, 60, 180));
        $this->addAftSystem(new MLPA(3, 9, 5, 60, 180));
