<?php
class Tashkat extends BaseShip{
    ...
    $this->phpclass = "tashkat";
    $this->imagePath = "img/ships/tashkat.png"; 
    $this->shipClass = "Tashkat Advanced Cruiser";
	...
	$this->addFrontSystem(new GraviticShifter(3, 0, 0, 270, 90));
	$this->addFrontSystem(new GravitonBeam(4, 8, 8, 300, 60));
	...
	$this->addLeftSystem(new GraviticShifter(3, 0, 0, 240, 0));
    $this->addLeftSystem(new GravitonBeam(4, 8, 8, 300, 0));
        
    $this->addRightSystem(new GraviticThruster(5, 13, 0, 8, 4));
    $this->addRightSystem(new GraviticShifter(3, 0, 0, 0, 120));
