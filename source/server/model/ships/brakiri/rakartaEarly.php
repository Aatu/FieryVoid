<?php
class RakartaEarly extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->addFrontSystem(new GraviticCutter(4, 6, 5, 240, 0));
		$this->addFrontSystem(new GraviticBolt(4, 5, 2, 180, 0));
		$this->addFrontSystem(new GraviticThruster(4, 8, 0, 2, 1));
		$this->addFrontSystem(new GraviticThruster(4, 8, 0, 2, 1));
		$this->addFrontSystem(new GraviticBolt(4, 5, 2, 0, 180));
		$this->addFrontSystem(new GraviticCutter(4, 6, 5, 0, 120));
