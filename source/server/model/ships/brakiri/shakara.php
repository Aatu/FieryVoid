<?php
class Shakara extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "shakara";
        $this->imagePath = "img/ships/shakara.png"; 
        $this->shipClass = "Shakara Scout Cruiser";
