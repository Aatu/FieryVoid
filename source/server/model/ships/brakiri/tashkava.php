<?php
class Tashkava extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "tashkava";
        $this->imagePath = "img/ships/tashkat.png"; 
        $this->shipClass = "Tashkava Advanced Lance Cruiser";
        $this->variantOf = "Tashkat Advanced Cruiser";
        $this->occurence = "rare";
	...
	$this->addFrontSystem(new GraviticShifter(4, 0, 0, 300, 60));
