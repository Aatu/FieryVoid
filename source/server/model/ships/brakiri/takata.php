...
class Takata extends BaseShip{
	...
	$this->addFrontSystem(new GraviticMine(4, 0, 0, 300, 60));
	$this->addFrontSystem(new GraviticMine(4, 0, 0, 300, 60));
	$this->addFrontSystem(new GraviticMine(4, 0, 0, 300, 60));
    ...
    $this->addAftSystem(new GravitonPulsar(4, 8, 8, 60, 240));
    $this->addAftSystem(new GraviticThruster(5, 15, 0, 8, 2));
    $this->addAftSystem(new GraviticThruster(5, 15, 0, 8, 2));


    $this->addLeftSystem(new GraviticThruster(5, 13, 0, 8, 3));
	$this->addLeftSystem(new GraviticMine(4, 12, 16, 240, 360));
	$this->addLeftSystem(new GraviticMine(4, 12, 16, 240, 360));	
        
    $this->addRightSystem(new GraviticThruster(5, 13, 0, 8, 4));
    $this->addRightSystem(new GraviticMine(4, 12, 16, 0, 120));
    $this->addRightSystem(new GraviticMine(4, 12, 16, 0, 120));	
