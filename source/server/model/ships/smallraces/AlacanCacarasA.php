<?php
class AlacanCacarasA extends OSAT{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		//$this->addPrimarySystem(new AlacanSoMissileRack(2, 6, 0, 270, 90));
