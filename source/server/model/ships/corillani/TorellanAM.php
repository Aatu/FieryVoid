<?php
class TorellanAM extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "TorellanAM";
        $this->imagePath = "img/ships/CorillaniMollanta.png";
        $this->shipClass = "Torellan Technology Cruiser";
        ...
        $this->addFrontSystem(new ParticleCannon(3, 8, 7, 300, 60));
        $this->addFrontSystem(new PlasmaProjector(3, 8, 5, 300, 60));
        ...
        $this->addAftSystem(new Thruster(4, 10, 0, 4, 2));       
 		...
 		$this->addLeftSystem(new PlasmaProjector(3, 8, 5, 300, 60));
        ...
        $this->addLeftSystem(new Hangar(2, 6));
 		...
 		$this->addRightSystem(new PlasmaProjector(3, 8, 5, 300, 60));
