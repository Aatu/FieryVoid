<?php
class KastanSteelsabre extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addAftSystem(new LightPlasma(2, 4, 2, 180, 300));
