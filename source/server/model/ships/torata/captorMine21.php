<?php
class captorMine21 extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "captorMine21";
        $this->imagePath = "img/ships/torataMine.png";
        $this->shipClass = "Class 2-1 Captor Mine";
        ...
        $this->addPrimarySystem(new CaptorMine(0, 1, 1, 0, 360, 6, 6, 1, 0, 16)); //$armour, $maxhealth, $powerReq, $startArc, $endArc, $range, $accuracy, $diceType, $dice, $damageBonus 
