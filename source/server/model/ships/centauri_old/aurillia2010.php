<?php
class Aurillia2010 extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "Aurillia2010";
        $this->imagePath = "img/ships/astur.png"; 
		$this->canvasSize = 200; 
        $this->shipSizeClass = 3;
        $this->shipClass = "Aurillia Cruiser (2010)";
        ...
        $this->addLeftSystem(new AssaultLaser(4, 6, 4, 300, 60));
        ...
        $this->addRightSystem(new AssaultLaser(4, 6, 4, 300, 60));
