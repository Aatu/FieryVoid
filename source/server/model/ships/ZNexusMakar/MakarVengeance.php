<?php
class MakarVengeance extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "MakarVengeance";
        $this->imagePath = "img/ships/Nexus/makarVengeance.png";
		$this->canvasSize = 120; //img has 200px per side
        $this->shipClass = "Makar Vengeance";
		...
		$this->addAftSystem(new NexusDefenseGun(1, 4, 1, 0, 360));
