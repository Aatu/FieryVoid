<?php
class SenschukaEarly extends MediumShip{
    ...
    $this->pointCost = 325;
    $this->faction = "Dilgar";
        $this->phpclass = "SenschukaEarly";
        $this->imagePath = "img/ships/senschuka.png";
        $this->shipClass = "Early Senschuka Patrol Ship";
			$this->variantOf = "Senschuka Patrol Ship";
        ...
        $this->addAftSystem(new LightPlasma(1, 4, 2, 120, 300));
        $this->addAftSystem(new LightPlasma(1, 4, 2, 60, 240));
