...
class JorthunL extends LCV{
	...
	$this->addPrimarySystem(new LightLaser(1, 4, 3, 240, 60));
	$this->addPrimarySystem(new LightLaser(1, 4, 3, 300, 120));
	$this->addPrimarySystem(new LightLaser(1, 4, 3, 270, 90));
