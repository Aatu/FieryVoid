<?php
class Virtue2004 extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->pointCost = 420;
		$this->faction = "Orieni";
        $this->phpclass = "Virtue2004";
        $this->imagePath = "img/ships/steadfast.png";
        $this->shipClass = "Virtue Strike Force Corvette (2004)";
        ...
        $this->addFrontSystem(new GaussCannon(2, 10, 4, 300, 60));
        $this->addFrontSystem(new OrieniGatlingRG(2, 4, 1, 180, 60));
        $this->addFrontSystem(new OrieniGatlingRG(2, 4, 1, 300, 180));
