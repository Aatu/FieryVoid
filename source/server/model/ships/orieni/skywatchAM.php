...
class skywatchAM extends OSAT
{
	...
	function __construct($id, $userid, $name,  $slot)
	{
        ...
        $this->addFrontSystem(new HeavyLaserLance(5, 6, 4, 270, 90));
        $this->addFrontSystem(new HeavyLaserLance(5, 6, 4, 270, 90));
		
		$this->addFrontSystem(new RapidGatling(2, 4, 1, 180, 360));
		$this->addFrontSystem(new RapidGatling(2, 4, 1, 0, 360));
		$this->addFrontSystem(new RapidGatling(2, 4, 1, 0, 360));
