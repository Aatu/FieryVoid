<?php
class Vigilant1704HKAM extends BaseShip{
  ...
  //      $this->enhancementOptionsEnabled[] = 'AMMO_L';//add enhancement options for other missiles - Class-L
        ...
        $this->addPrimarySystem(new Hangar(4, 14, 6, 0, 'fighters', array(), false, array('HkShiningLight', 'HkShiningStar', 'Templar', 'HighTemplar')));
