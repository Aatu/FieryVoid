<?php
class ChoukaPriestEscort extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addAftSystem(new EWPointPlasmaGun(2, 3, 1, 60, 300));
        $this->addAftSystem(new EWPointPlasmaGun(2, 3, 1, 60, 300));
        $this->addAftSystem(new EWPointPlasmaGun(1, 3, 1, 90, 270));
