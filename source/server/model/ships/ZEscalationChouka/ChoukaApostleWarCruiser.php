<?php
class ChoukaApostleWarCruiser extends BaseShip{
	...
	$this->faction = "ZEscalation Chouka";
        $this->phpclass = "ChoukaApostleWarCruiser";
        $this->imagePath = "img/ships/EscalationWars/ChoukaApostleCruiser.png";
        $this->shipClass = "Apostle War Cruiser";
	...
	$this->isd = 1972;
		...
		$this->addFrontSystem(new EWTwinLaserCannon(2, 8, 4, 300, 60));
		$this->addFrontSystem(new EWHeavyPointPlasmaGun(2, 7, 2, 300, 60));
		$this->addFrontSystem(new EWHeavyPointPlasmaGun(2, 7, 2, 300, 60));
