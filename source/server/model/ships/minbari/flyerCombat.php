...
class FlyerCombat extends FighterFlight{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->hangarRequired = 'flyers'; //for fleet check; they replace regular shuttles (rather than assault shuttles!) - which means a ship needs shuttle hangar tracked for it to work!
