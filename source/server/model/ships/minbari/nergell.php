...
class Nergell extends SmallStarBaseFourSections{
	...
	function __construct($id, $userid, $name,  $slot){
		...
		$this->addFrontSystem(new ShockCannon(4, 6, 4, 315, 45));
		$this->addFrontSystem(new FusionCannon(3, 8, 1, 315, 45));
		$this->addFrontSystem(new FusionCannon(3, 8, 1, 315, 45));
		$this->addFrontSystem(new FusionCannon(3, 8, 1, 225, 45));

		$this->addAftSystem(new NeutronLaser(4, 10, 6, 135, 225));
		$this->addAftSystem(new ShockCannon(4, 6, 4, 135, 225));
		$this->addAftSystem(new FusionCannon(3, 8, 1, 135, 225));
		$this->addAftSystem(new FusionCannon(3, 8, 1, 135, 225));
		$this->addAftSystem(new FusionCannon(3, 8, 1, 45, 225));
		
		$this->addRightSystem(new NeutronLaser(4, 10, 6, 45, 135));
		$this->addRightSystem(new ShockCannon(4, 6, 4, 45, 135));
		$this->addRightSystem(new FusionCannon(3, 8, 1, 45, 135));
		$this->addRightSystem(new FusionCannon(3, 8, 1, 45, 135));
		$this->addRightSystem(new FusionCannon(3, 8, 1, 315, 135));
		
		$this->addLeftSystem(new NeutronLaser(4, 10, 6, 225, 315));
		$this->addLeftSystem(new ShockCannon(4, 6, 4, 225, 315));
		$this->addLeftSystem(new FusionCannon(3, 8, 1, 225, 315));
		$this->addLeftSystem(new FusionCannon(3, 8, 1, 225, 315));
		$this->addLeftSystem(new FusionCannon(3, 8, 1, 135, 315));
		}
    }
