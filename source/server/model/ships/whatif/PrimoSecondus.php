...
class PrimoSecundus extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->shipClass = "House Valheru Primo Secondus";
        $this->shipSizeClass = 3;
        $this->isd = 2240;
			$this->variantOf = "House Valheru Primo Gunship";
		...
		$this->addRightSystem(new CustomHeavyMatterCannon(4, 7, 4, 45, 135));
		$this->addRightSystem(new CustomHeavyMatterCannon(4, 7, 4, 45, 135));
