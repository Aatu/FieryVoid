<?php
class VorcharianD extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->shipClass = "Hours Valheru Vorcharian D-class";
			$this->variantOf = "House Valheru Vorcharian Warship";
        ...
        $this->addPrimarySystem(new Reactor(7, 12, 0, 2));
        ...
        $this->addFrontSystem(new TwinArray(3, 6, 2, 240, 120));
		$this->addFrontSystem(new CustomHeavyMatterCannon(3, 10, 6, 300, 60));
