...
class Kitsune extends LCV{
	...
	$this->shipClass = "House Valheru Kitsune Anti-fighter Platform";
	$this->imagePath = "img/ships/Kitsune.png";
	$this->canvasSize = 90;
	$this->agile = true;
	...
	$this->addFrontSystem(new CustomLightMatterCannon(3, 6, 2, 300, 60));
	$this->addFrontSystem(new CustomLightMatterCannon(3, 6, 2, 300, 60));
