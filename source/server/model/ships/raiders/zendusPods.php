<?php
class ZendusPods extends BaseShip{
	...
	function __construct($id, $userid, $name,  $slot)
	{
		...
		$this->phpclass = "ZendusPods";
		$this->shipClass = "Raider Zendus Cruiser (w/Cargo Pods)";
		$this->variantOf = "Raider Zendus Cruiser";
		$this->occurence = "common";
		$this->imagePath = "img/ships/RaiderZendusPods.png";
		$this->canvasSize = 200;
		...
		$this->notes .= "<br> ";
		$this->notes = "Used by Torata Raiders.";
		$this->notes .= "<br> ";
		...
		$this->addFrontSystem(new MediumLaser(6, 6, 5, 300, 60));
