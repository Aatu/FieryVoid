<?php
class PrivateerHandus extends BaseShip{
	...
	function __construct($id, $userid, $name,  $slot)
	{
		...
		$this->phpclass = "PrivateerHandus";
		$this->shipClass = "Torata Privateer Handus Jump Carrier";
		$this->variantOf = "Raider Zendus Cruiser";
		$this->occurence = "common";
		$this->imagePath = "img/ships/TorataPrivateerZendusPods.png";
		$this->canvasSize = 200;
        ...
        $this->addLeftSystem(new Hangar(2, 12, 6, 5));

		$this->addRightSystem(new Thruster(4, 15, 0, 4, 4));
        $this->addRightSystem(new Hangar(2, 12, 6, 1));
