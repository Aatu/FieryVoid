<?php
class ChoukaRaiderJumpcruiser extends BaseShip{
	...
	$this->faction = "ZEscalation Chouka Raider";
        $this->phpclass = "ChoukaRaiderJumpcruiser";
        $this->imagePath = "img/ships/EscalationWars/ChoukaRaiderCruiser.png";
        $this->shipClass = "Hand of God Raiding Jumpcruiser";
			$this->variantOf = "Hand of God Raiding Cruiser";
