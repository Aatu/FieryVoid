<?php
class captorMineBType3 extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "captorMineBType3";
        $this->imagePath = "img/ships/eaMine.png";
        $this->shipClass = "Type-3 Captor Mine";
		$this->occurence = "common";
		$this->variantOf = "Type-2 Captor Mine";
        $this->isd = 2109;
        ...
        $this->addPrimarySystem(new CaptorMine(0, 1, 1, 0, 360, 6, 6, 1, 0, 15)); //$armour, $maxhealth, $powerReq, $startArc, $endArc, $range, $accuracy, $diceType, $dice, $damageBonus 
