...
//        $this->addPrimarySystem(new AntiquatedScanner(3, 10, 2, 4));
		...
		$this->addFrontSystem(new NexusDefenseGun(2, 4, 1, 180, 360));
		$this->addFrontSystem(new NexusXRayLaser(3, 5, 2, 300, 60));
		$this->addFrontSystem(new NexusDefenseGun(2, 4, 1, 0, 180));
