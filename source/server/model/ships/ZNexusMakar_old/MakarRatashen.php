<?php
class MakarRatashen extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->addFrontSystem(new PlasmaTorch(3, 4, 2, 240, 60));
		$this->addFrontSystem(new PlasmaTorch(3, 4, 2, 270, 90));
		$this->addFrontSystem(new PlasmaTorch(3, 4, 2, 300, 120));
