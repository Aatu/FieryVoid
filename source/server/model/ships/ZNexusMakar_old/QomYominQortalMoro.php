<?php
class QomYominQortalMoro extends BaseShip{
	...
	$this->faction = "ZNexus Makar Federation (early)";
        $this->phpclass = "QomYominQortalMoro";
        $this->imagePath = "img/ships/Nexus/makar_qortalmoro2.png";
        $this->shipClass = "Qortal Moro Explorer";
        ...
        $this->addPrimarySystem(new Reactor(4, 25, 0, 6));
