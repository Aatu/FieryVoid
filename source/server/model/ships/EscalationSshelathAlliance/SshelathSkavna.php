<?php
class SshelathSkavna extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "SshelathSkavna";
        $this->imagePath = "img/ships/EscalationWars/SshelathSkavna.png";
        $this->shipClass = "Skavna Torpedo Frigate";
		...
		$this->addAftSystem(new NexusLightLaserCutter(2, 4, 3, 180, 300));
		$this->addAftSystem(new NexusLightLaserCutter(2, 4, 3, 60, 180));
