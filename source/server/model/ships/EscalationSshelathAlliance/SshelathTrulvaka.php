<?php
class SshelathTrulvaka extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "SshelathTrulvaka";
        $this->imagePath = "img/ships/EscalationWars/SshelathTrovalta.png";
        $this->shipClass = "Trulvaka Attack Frigate";
		...
		$this->addFrontSystem(new EWEarlyRailgun(2, 9, 6, 270, 90));
