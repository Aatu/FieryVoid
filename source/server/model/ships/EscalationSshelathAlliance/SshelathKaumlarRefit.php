<?php
class SshelathKaumlarRefit extends OSAT{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "SshelathKaumlarRefit";
        $this->imagePath = "img/ships/EscalationWars/SshelathKaumlar.png";
        $this->shipClass = "Kaumlar Command Fortress (refit)";
			$this->variantOf = "Kaumlar Command Fortress";
        ...
        $ammoMagazine = new AmmoMagazine(96); //pass magazine capacity - 60 rounds per launcher
        ...
        $this->addAftSystem(new AmmoMissileRackSO(2, 0, 0, 90, 270, $ammoMagazine, true)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addAftSystem(new AmmoMissileRackSO(2, 0, 0, 90, 270, $ammoMagazine, true)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addAftSystem(new AmmoMissileRackSO(2, 0, 0, 90, 270, $ammoMagazine, true)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addAftSystem(new AmmoMissileRackSO(2, 0, 0, 90, 270, $ammoMagazine, true)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
		...
		$this->hitChart = array(
                0=> array(
                        9 => "Structure",
                        11 => "1:Class-SO Missile Rack",
                        13 => "2:Class-SO Missile Rack",
                        16 => "Defense Laser",
                        18 => "Scanner",
                        20 => "Reactor",
                ),
