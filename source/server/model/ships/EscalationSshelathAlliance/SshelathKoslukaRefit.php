<?php
class SshelathKoslukaRefit extends LCV{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "SshelathKoslukaRefit";
        $this->imagePath = "img/ships/EscalationWars/SshelathKosluka.png";
			$this->canvasSize = 55; //img has 200px per side
        $this->shipClass = "Kosluka Corvette (1928 refit)";
			$this->variantOf = "Kosluka Corvette";
...
//			$this->addPrimarySystem($sensors);
        ...
        $this->hitChart = array(
        		0=> array( 
        				10 => "Structure",
        				12 => "1:Light Class-SO Missile Rack",
        				15 => "1:Defense Laser",
						17 => "0:Engine",
        				19 => "0:Reactor",
        				20 => "0:Scanner",
