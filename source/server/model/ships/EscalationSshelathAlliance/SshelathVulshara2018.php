<?php
class SshelathVulshara2018 extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "SshelathVulshara2018";
        $this->imagePath = "img/ships/EscalationWars/SshelathVulshara.png";
        $this->shipClass = "Vulshara Heavy Cruiser (refit)";
        ...
        $this->addFrontSystem(new Thruster(3, 10, 0, 3, 1));
        $this->addFrontSystem(new EWHvyEMLaser(4, 8, 7, 300, 60));
        $this->addFrontSystem(new EWHvyEMLaser(4, 8, 7, 300, 60));
