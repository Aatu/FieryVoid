<?php
class KlingonD5Tanker extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->variantOf = "Klingon D5 Cruiser";
		...
		$this->addFrontSystem(new TrekLightDisruptorArray(3, 6, 3, 240, 120));
