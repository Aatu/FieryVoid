<?php
class BloodSwordChariotBP extends FighterFlight{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "BloodSwordChariotBP";
        $this->shipClass = "Chariot Breaching Sled";
        $this->imagePath = "img/ships/EscalationWars/BloodSwordChariot.png";
        $this->isd = 1902;
...
//	    $this->notes = 'Non-atmospheric.';
    ...
    public function populate(){
        ...
        for ($i = 0; $i < $toAdd; $i++){
            ...
            $fighter = new Fighter("BloodSwordChariotBP", $armour, 13, $this->id);
            $fighter->displayName = "Chariot";
            $fighter->imagePath = "img/ships/EscalationWars/BloodSwordChariot.png";
            $fighter->iconPath = "img/ships/EscalationWars/BloodSwordChariot_large.png";
