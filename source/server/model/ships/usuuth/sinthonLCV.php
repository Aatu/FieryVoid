<?php
class SinthonLCV extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->canvasSize = 200;
        $this->shipClass = "Sinthon LCV Carrier";
        $this->isd = 1954;
        $this->occurence = "uncommon";
        $this->variantOf = "Serron Attack Ship";
        $this->fighters = array("LCVs"=>3);
		
	    $this->unofficial = 'S'; //Semi-official - added to Usuuth fleet list to allow tournament-legal fleets with LCVs
