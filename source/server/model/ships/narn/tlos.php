...
class Tlos extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "Tlos";
        $this->imagePath = "img/ships/NarnTlos.png";
        $this->shipClass = "Narn T'los Bulk Freighter (2243 Refit)";
			$this->occurence = "common";
			$this->variantOf = "Narn T'los Bulk Freighter";  
        ...
        $this->addFrontSystem(new LightPulse(2, 4, 1, 270, 90));        
        $this->addFrontSystem(new Thruster(4, 10, 0, 3, 1));
        $this->addFrontSystem(new Thruster(4, 10, 0, 3, 1)); 
        $this->addFrontSystem(new LightPulse(2, 4, 1, 270, 90));
			
		$this->addAftSystem(new LightPulse(2, 4, 1, 90, 270));
		$this->addAftSystem(new LightPulse(2, 4, 1, 90, 270));
