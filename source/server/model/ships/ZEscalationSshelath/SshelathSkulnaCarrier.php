<?php
class SshelathSkulnaCarrier extends BaseShip{
	...
	$this->faction = "ZEscalation Sshelath";
        $this->phpclass = "SshelathSkulnaCarrier";
        $this->imagePath = "img/ships/EscalationWars/SshelathSkraltna.png";
        $this->shipClass = "Skrulna Carrier";
		...
		$this->addAftSystem(new EWDefenseLaser(1, 2, 1, 90, 270));
		$this->addAftSystem(new EWDefenseLaser(1, 2, 1, 90, 270));
