<?php
class KastanChariotBP extends FighterFlight{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "KastanChariotBP";
        $this->shipClass = "Chariot Breaching Sled";
        $this->imagePath = "img/ships/EscalationWars/KastanChariot.png";
        $this->isd = 1871;
...
//	    $this->notes = 'Non-atmospheric.';
    ...
    public function populate(){
        ...
        for ($i = 0; $i < $toAdd; $i++){
            ...
            $fighter = new Fighter("KastanChariotBP", $armour, 13, $this->id);
            $fighter->displayName = "Chariot";
            $fighter->imagePath = "img/ships/EscalationWars/KastanChariot.png";
            $fighter->iconPath = "img/ships/EscalationWars/KastanChariot_large.png";
