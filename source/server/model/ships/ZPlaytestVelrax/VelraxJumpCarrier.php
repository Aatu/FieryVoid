...
class VelraxStrikeCarrierRefit extends BaseShip{
	...
	$this->faction = "ZPlaytest Velrax";
        ...
        $this->addFrontSystem(new NexusChargedPlasmaGun(3, 5, 2, 300, 60));
        $this->addFrontSystem(new NexusChargedPlasmaGun(3, 5, 2, 300, 60));
        ...
        $this->addAftSystem(new Thruster(2, 9, 0, 2, 2));
        $this->addAftSystem(new Thruster(2, 9, 0, 2, 2));
		$this->addAftSystem(new JumpEngine(3, 15, 5, 40));
        ...
        $this->addRightSystem(new NexusParticleArray(2, 4, 2, 0, 120));
