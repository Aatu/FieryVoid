<?php
class CenturionMD extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $movement){
        ...
        $this->phpclass = "CenturionMD";
	    $this->isd = 2202;
        $this->imagePath = "img/ships/centurion.png";
        $this->shipClass = "Centurion Attack Cruiser (Mass Driver)";
       ...
       $this->variantOf = "Centurion Attack Cruiser";		
        ...
        $this->addPrimarySystem(new Reactor(7, 22, 0, -9));
