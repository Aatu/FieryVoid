<?php
class CentauriLightTransportArmed extends LCV{
	...
	$this->phpclass = "CentauriLightTransportArmed";
	$this->shipClass = "Centauri Armed Light Transport";
        $this->variantOf = "Centauri Light Transport";
        $this->occurence = "common";
	$this->imagePath = "img/ships/CentauriLightTransport.png";
	$this->canvasSize = 100;
	...
	$this->addPrimarySystem(new Engine(4, 6, 0, 4, 1));
