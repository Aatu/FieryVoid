<?php
class PrimusMD extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "PrimusMD";
        $this->imagePath = "img/ships/primus.png";
        $this->shipClass = "Primus Battlecruiser (Mass Driver)";
       ...
       $this->variantOf = "Primus Battlecruiser";
        ...
        $this->addPrimarySystem(new Reactor(8, 22, 0, -9));
	...
	$this->addFrontSystem(new TwinArray(3, 6, 2, 240, 120));
        $this->addFrontSystem(new TwinArray(3, 6, 2, 240, 300, 60, 120));
