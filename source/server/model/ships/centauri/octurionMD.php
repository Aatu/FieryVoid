<?php
class OcturionMD extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "OcturionMD";
        $this->imagePath = "img/ships/octurion.png";
        $this->shipClass = "Octurion Battleship (Mass Driver)";
       ...
       $this->variantOf = "Octurion Battleship";
        ...
        $this->addPrimarySystem(new Reactor(8, 35, 0, -18));
	...
	$this->addAftSystem(new Thruster(5, 8, 0, 2, 2));
		...
		$this->addLeftSystem(new TwinArray(3, 6, 2, 180, 300));
		$this->addLeftSystem(new TwinArray(3, 6, 2, 180, 300));
		$this->addLeftSystem(new Thruster(5, 15, 0, 5, 3));
        	$this->addLeftSystem(new MassDriver(5, 18, 9, 330, 30));

		$this->addRightSystem(new BattleLaser(4, 6, 6, 0, 120));
		$this->addRightSystem(new BattleLaser(4, 6, 6, 0, 120));
		$this->addRightSystem(new MatterCannon(4, 7, 4, 0, 120));
		$this->addRightSystem(new TwinArray(3, 6, 2, 60, 180));
		$this->addRightSystem(new TwinArray(3, 6, 2, 60, 180));
		$this->addRightSystem(new Thruster(5, 15, 0, 5, 4));
        	$this->addRightSystem(new MassDriver(5, 18, 9, 330, 30));
