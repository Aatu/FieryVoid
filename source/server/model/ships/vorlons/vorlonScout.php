<?php
class VorlonScout extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$scanner = new ElintScanner(6, 24, 0, 15);//Vorlon Scanners do not need power - base systems are included in zero hull running costs
