<?php
class VorlonHeavyDestroyer extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "VorlonHeavyDestroyer";
        $this->shipClass = "Heavy Destroyer";
		...
		$this->addPrimarySystem(new PowerCapacitor( 6, 26, 0, 13, true));//armor, structure, power req, output, has petals 
        ...
        $this->addFrontSystem(new VorlonDischargeCannon(4, 0, 0, 240, 120));
        ...
        $this->addFrontSystem(new Structure( 5, 90));
