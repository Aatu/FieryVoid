<?php
class baradaTomguScoutCruiser extends BaseShip{
	...
	function __construct($id, $userid, $name,  $slot)
	{
		...
		$this->shipClass = "Tomgu Scout Cruiser";
		$this->phpclass = "baradaTomguScoutCruiser";
		...
		$this->addPrimarySystem(new ElintScanner(6, 24, 4, 5));
