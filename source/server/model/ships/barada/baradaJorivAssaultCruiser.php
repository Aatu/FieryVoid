<?php
class baradaJorivAssaultCruiser extends BaseShip{
	...
	function __construct($id, $userid, $name,  $slot)
	{
		...
		$this->shipClass = "Joriv Assault Cruiser";
		$this->phpclass = "baradaJorivAssaultCruiser";
		...
		$this->addAftSystem(new LightParticleBeamShip(2, 4, 1, 0, 360));
        $this->addAftSystem(new LightParticleBeamShip(2, 4, 1, 0, 360));
		...
		$this->addLeftSystem(new HeavyParticleBeam(2, 2, 1, 240, 60));
		...
		$this->addRightSystem(new HeavyParticleBeam(2, 2, 1, 300, 120));
