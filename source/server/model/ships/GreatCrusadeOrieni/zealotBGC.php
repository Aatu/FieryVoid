<?php
class zealotBGC extends BaseShipNoAft{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "zealotBGC";
        $this->imagePath = "img/ships/GCzealot.png";
		$this->canvasSize = 165; //img has 200px per side
        $this->shipClass = "Zealot Cruiser (Beta)";
        	$this->variantOf = "Zealot Cruiser";
        ...
        $this->addLeftSystem(new LightLaserLance(2, 6, 5, 240, 360));
        ...
        $this->addRightSystem(new LightLaserLance(2, 6, 5, 0, 120));
