<?php
class vigilantGCAM extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "vigilantGCAM";
        $this->imagePath = "img/ships/GCvigilant.png";
        $this->shipClass = "Vigilant Support Ship";
	    $this->isd = 2203;
        ...
        $this->addFrontSystem(new ImpRapidGatling(2, 4, 2, 240, 120));
        $this->addFrontSystem(new ImpRapidGatling(2, 4, 2, 240, 120));
		$this->addFrontSystem(new AmmoMissileRackL(5, 0, 0, 240, 60, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
		$this->addFrontSystem(new AmmoMissileRackL(5, 0, 0, 300, 120, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
