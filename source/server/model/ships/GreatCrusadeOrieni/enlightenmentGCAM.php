<?php
class enlightenmentGCAM extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "enlightenmentGCAM";
        $this->imagePath = "img/ships/GCenlightenment.png";
        $this->shipClass = "Enlightenment Invader (2237)";
        ...
        $this->addFrontSystem(new WarLance(2, 9, 6, 240, 60));
        $this->addFrontSystem(new WarLance(2, 9, 6, 300, 120));
		...
		$this->addLeftSystem(new AmmoMissileRackL(3, 0, 0, 180, 300, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
		...
		$this->addRightSystem(new AmmoMissileRackL(3, 0, 0, 60, 180, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
