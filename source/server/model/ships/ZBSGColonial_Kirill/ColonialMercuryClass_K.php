<?php
class ColonialMercuryClass_K extends BaseShip{
	...
	$this->faction = "ZPlaytest 12 Colonies of Kobol (Tier 1)";
        $this->phpclass = "ColonialMercuryClass_K";
...
//        $this->addAftSystem(new Thruster(5, 9, 0, 3, 2));
		...
		$this->addAftSystem(new Bulkhead(0, 4));
		$this->addAftSystem(new Bulkhead(0, 4));
//		$this->addAftSystem(new LtBlastCannon(4, 4, 1, 150, 270));
//		$this->addAftSystem(new LtBlastCannon(4, 4, 1, 150, 270));
//		$this->addAftSystem(new LtBlastCannon(4, 4, 1, 90, 210));
//		$this->addAftSystem(new LtBlastCannon(4, 4, 1, 90, 210));
