<?php
class CircasianTormin extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addAftSystem(new LightParticleCannon(2, 6, 5, 180, 300));
        $this->addAftSystem(new LightParticleCannon(2, 6, 5, 60, 180));
        
        //0:primary, 1:front, 2:rear, 3:left, 4:right;
        $this->addFrontSystem(new Structure( 4, 46));
        $this->addAftSystem(new Structure( 3, 46));
