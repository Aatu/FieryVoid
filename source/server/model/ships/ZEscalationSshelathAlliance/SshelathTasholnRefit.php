<?php
class SshelathTasholnRefit extends HeavyCombatVesselLeftRight{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "SshelathTasholnRefit";
        $this->imagePath = "img/ships/EscalationWars/SshelathTasholn.png";
        $this->shipClass = "Tasholn Destroyer (1964 Refit)";
