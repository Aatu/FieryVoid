<?php
class SshelathSkonnaRefit extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "SshelathSkonnaRefit";
        $this->imagePath = "img/ships/EscalationWars/SshelathSkonna.png";
        $this->shipClass = "Skonna Corvette (1944 Refit)";
			$this->variantOf = "Skonna Corvette";
		...
		$this->addFrontSystem(new Railgun(2, 9, 6, 240, 120));
