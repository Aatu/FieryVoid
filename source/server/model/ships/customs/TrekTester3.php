<?php
class TrekTester3 extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "TrekTester3";
        $this->imagePath = "img/ships/StarTrek/EnterpriseNX.png";
        $this->shipClass = "Trek Testbed ShieldProjection";
		...
		$impulseDrive = new TrekImpulseDrive(3,20,0,2,3); //Impulse Drive is an engine in its own right, in addition to serving as hub for Nacelle output: $armour, $maxhealth, $powerReq, $output, $boostEfficiency
		...
		$warpNacelle = new TrekWarpDrive(4, 18, 0, 4); //armor, structure, power usage, impulse output
		...
		$projection = new TrekShieldProjection(1, 10, 3, 90, 270, 'F');//parameters: $armor, $maxhealth, $rating, $arc from/to - F/A/L/R suggests whether to use left or right graphics
