<?php
class MedViper extends FighterFlight{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->hangarRequired = 'Vipers'; //for fleet check
		$this->unitSize = 1; //2 Mk2s should fit in space of 1 Mk7
