<?php
class VariableHangarSize extends BaseShip{
	...
	$this->faction = "Custom Ships";
        $this->phpclass = "VariableHangarSize";
        $this->imagePath = "img/ships/BSG/ColonialBerserk.png";
        $this->shipClass = "Variable Hangar Size Carrier";
...
//		$this->unlimited 
        ...
        $this->notes .= '<br>Has 12 Viper slots. Each Mk7 takes 1 slot, each Mk2 takes half a slot.';
		$this->isd = 1948;
