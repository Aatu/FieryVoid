<?php
class OcaraC extends MineClass{
    function __construct($id, $userid, $name,  $slot){
        parent::__construct($id, $userid, $name,  $slot);
        
        $this->pointCost = 60*6;
        $this->faction = "Custom Ships";
        $this->phpclass = "OcaraC";
        $this->shipClass = "Ocara-C Mine";
...
//    	$this->superheavy = true;
    ...
    public function populate(){
        ...
        for ($i = 0; $i < $toAdd; $i++){
            ...
            $fighter = new Fighter("Ocara-C", $armour, 12, $this->id);
            $fighter->displayName = "Ocara-C";
            $fighter->imagePath = "img/ships/mine.png";
            $fighter->iconPath = "img/ships/mine_large.png"; 

			$MC = new MCFtr8(0, 360, 1);
			$fighter->addFrontSystem($MC);
			$TA = new TAFtr8(0, 360, 1);
