<?php
class test_MISSING_scanner extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "test_MISSING_scanner";
        $this->imagePath = "img/ships/gquan.png";
        $this->shipClass = "test_MISSING_scanner";
...
//			$this->occurence = "common";
	    ...
	    $this->notes = 'Custom test MISSING scanner.';
