...
class shadowOSAT extends OSAT{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "shadowOSAT";
        $this->imagePath = "img/ships/ShadowDestroyer.png";
        $this->shipClass = "Shadow OSAT";
			$this->canvasSize = 90; 
        $this->isd = 'Ancient';
		...
		//weapons - Forward for visual reasons!
        	$this->addFrontSystem(new PhasingPulseCannonH(4, 0, 0, 300, 60));
		...
		$this->hitChart = array(
                0=> array(
                        ...
                        12 => "2:Thruster",
                        14 => "0:Self Repair",
						16 => "1:Heavy Phasing Pulse Cannon",
                        18 => "Scanner",
						20 => "Reactor",
                ),
                1=> array(
