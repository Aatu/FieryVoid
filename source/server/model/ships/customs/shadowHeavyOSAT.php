<?php
class shadowHeavyOSAT extends OSAT{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "shadowHeavyOSAT";
        $this->imagePath = "img/ships/ShadowDestroyer.png";
        $this->shipClass = "Shadow Heavy OSAT";
			$this->canvasSize = 110; 
        $this->isd = 'Ancient';
		...
		//EnergyDiffuser		
		$diffuserPort = new EnergyDiffuser(4, 12, 10, 180, 360);//($armour, $maxhealth, $dissipation, $startArc, $endArc)
		...
		//NOTE: Used a standard thruster as this is an OSAT and functionally works like a bio thruster
			$this->addAftSystem(new Thruster(5, 20, 0, 0, 2)); 

        $this->addPrimarySystem(new OSATCnC(0, 1, 0, 0));
                
        //0:primary, 1:front, 2:rear, 3:left, 4:right;
        $this->addPrimarySystem(new Structure(6, 33));
