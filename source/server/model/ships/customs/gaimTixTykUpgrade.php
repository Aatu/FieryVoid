<?php
class gaimTixTykUpgrade extends HeavyCombatVesselLeftRight{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "gaimTixTykUpgrade";
        $this->imagePath = "img/ships/Tixtyk.png";
        $this->shipClass = "Tixtyk Heavy Destroyer (Upgrade)";
			$this->variantOf = "Tixtyk Heavy Destroyer";
