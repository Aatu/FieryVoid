<?php
class PolarenWyrith extends HeavyCombatVesselLeftRight{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "PolarenWyrith";
        $this->imagePath = "img/ships/Nexus/polarenGratherin.png";
        $this->shipClass = "Wyrith Tender";
...
//        $this->addRightSystem(new Maser(2, 6, 3, 300, 120));
        ...
        $this->addRightSystem(new NexusLightMaser(2, 2, 2, 0, 180));
