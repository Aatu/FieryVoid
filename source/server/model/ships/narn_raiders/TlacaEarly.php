<?php
class TlacaEarly extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "TlacaEarly";
        $this->imagePath = "img/ships/NarnPrivateerTlacaEarly.png";
        $this->shipClass = "Narn Privateer T'Laca Light Carrier (Early)";
        $this->canvasSize = 100;
