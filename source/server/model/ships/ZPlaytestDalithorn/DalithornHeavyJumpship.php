<?php
class DalithornHeavyJumpship extends BaseShip{
	...
	$this->faction = "ZPlaytest Dalithorn";
        $this->phpclass = "DalithornHeavyJumpship";
        $this->imagePath = "img/ships/Playtest/DalithornDreadnought.png";
        $this->shipClass = "Heavy Jumpship";
        ...
        $this->addPrimarySystem(new Engine(3, 15, 0, 8, 3));
