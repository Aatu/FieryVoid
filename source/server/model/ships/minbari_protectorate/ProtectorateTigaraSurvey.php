<?php
class ProtectorateTigaraSurvey extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "ProtectorateTigaraSurvey";
        $this->imagePath = "img/ships/tigara.png";
        $this->shipClass = "Tigara Jump Cruiser";
        ...
        $this->addPrimarySystem(new JumpEngine(6, 20, 5, 16));
