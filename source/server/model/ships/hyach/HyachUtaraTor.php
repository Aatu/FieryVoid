...
//        $this->addPrimarySystem(new CnC(6, 72, 0, 0));
		...
		$HyachSpecialists = $this->createHyachSpecialists(3); //$specTotal Should be 6 for base, but just setting it to max available (even tho they can't all be used by a base, it means it can get past error message on Turn 1)
