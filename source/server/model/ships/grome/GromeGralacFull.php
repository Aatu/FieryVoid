<?php
class GromeGralacFull extends BaseShip{
/*Gralac with fully decked out railguns with special shells!*/    
...
The costs before rounding the final value are: 
		...
		Estimated cost is 900 + (4x24) = 996 -> rounded to 1000*/        
	$this->pointCost = 1000;
	$this->faction = "Grome";
        $this->phpclass = "GromeGralacFull";
        $this->imagePath = "img/ships/GromeGroth.png";
        $this->shipClass = "Gralac Heavy Carrier (full)";
