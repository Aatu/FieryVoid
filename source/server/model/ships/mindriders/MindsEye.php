...
class MindsEye extends SixSidedShip{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->addRightFrontSystem(new ThoughtShield(0, 50, 25, 30, 90, 'FS'));
		$this->addLeftFrontSystem(new ThoughtShield(0, 50, 25, 270, 330, 'FP'));
		$this->addAftSystem(new ThoughtShield(0, 50, 25, 150, 210, 'A'));	
		$this->addRightAftSystem(new ThoughtShield(0, 50, 25, 90, 150, 'AS'));
