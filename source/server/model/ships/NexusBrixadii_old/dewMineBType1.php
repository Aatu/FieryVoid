<?php
class dewMineBtype1 extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "dewMineBtype1";
        $this->imagePath = "img/ships/descariMine.png";
        $this->shipClass = "Light Particle Beam DEW Mine";
        ...
        $this->addPrimarySystem(new MineControllerDEW(0, 1, 0, 5, 5)); //$armour, $maxhealth, $powerReq, $startArc, $endArc, $range/output, $accuracy 
