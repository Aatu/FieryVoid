<?php
class WatcherScout extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
 	...
 	$this->limited = 33;
        ...
        $this->addPrimarySystem(new ElintScanner(4, 12, 8, 8));
	...
	$this->addPrimarySystem(new Hangar(3, 8));
        ...
        $this->addFrontSystem(new Thruster(4, 8, 0, 3, 1));
	$this->addFrontSystem(new AssaultLaser(3, 6, 3, 270, 60));
