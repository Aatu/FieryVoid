<?php
class VelraxHisshrimRefit2 extends HeavyCombatVesselLeftRight{
	...
	$this->faction = "Nexus Velrax Republic";
		...
		$this->addLeftSystem(new Hangar(3, 8, 6, 3));
		...
		$this->addRightSystem(new Hangar(3, 8, 6, 3));
