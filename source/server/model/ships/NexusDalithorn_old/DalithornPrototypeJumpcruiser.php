<?php
class DalithornPrototypeJumpcruiser extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->imagePath = "img/ships/Nexus/Dalithorn_PrototypeJumpship2.png";
        ...
        $this->addPrimarySystem(new Engine(3, 16, 0, 8, 4));
        $this->addPrimarySystem(new Hangar(1, 2));
		$this->addPrimarySystem(new Magazine(3, 6));
		...
		$this->addFrontSystem(new JumpEngine(4, 20, 8, 65));
