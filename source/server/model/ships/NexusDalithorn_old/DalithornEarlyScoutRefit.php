<?php
class DalithornEarlyScoutRefit extends HeavyCombatVessel{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addPrimarySystem(new ELINTScanner(3, 14, 5, 5));
        ...
        $this->addFrontSystem(new Thruster(2, 10, 0, 2, 1));
        $this->addFrontSystem(new ELINTScanner(3, 10, 5, 3));
        ...
        $this->addAftSystem(new Thruster(1, 4, 0, 2, 2));
        $this->addAftSystem(new NexusLightGasGun(2, 5, 1, 300, 60));
        $this->addAftSystem(new NexusLightGasGun(2, 5, 1, 300, 60));
        $this->addAftSystem(new NexusShatterGun(1, 2, 1, 120, 360));
        $this->addAftSystem(new NexusShatterGun(1, 2, 1, 0, 240));
