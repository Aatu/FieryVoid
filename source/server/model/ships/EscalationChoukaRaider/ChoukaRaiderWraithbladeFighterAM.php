<?php
class ChoukaRaiderWraithbladeFighterAM extends FighterFlight{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "ChoukaRaiderWraithbladeFighterAM";
        $this->shipClass = "Wraithblade Heavy flight";
        $this->imagePath = "img/ships/EscalationWars/ChoukaRaiderWraithblade.png";
    ...
    public function populate(){
        ...
        for ($i = 0; $i < $toAdd; $i++){            
            ...
            $fighter = new Fighter("ChoukaRaiderWraithbladeFighterAM", $armour, 11, $this->id);
            $fighter->displayName = "Wraithblade";
            $fighter->imagePath = "img/ships/EscalationWars/ChoukaRaiderWraithblade.png";
            $fighter->iconPath = "img/ships/EscalationWars/ChoukaRaiderWraithblade_Large.png";
