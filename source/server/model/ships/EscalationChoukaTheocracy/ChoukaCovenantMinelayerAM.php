<?php
class ChoukaCovenantMinelayerAM extends BaseShip{
	...
	$this->faction = "Escalation Wars Chouka Theocracy";
        $this->phpclass = "ChoukaCovenantMinelayerAM";
	...
	$ammoMagazine = new AmmoMagazine(64); //80+20 Basic, 80 Intercept and up to 40 Mines
...
//	    $ammoMagazine->addAmmoEntry(new AmmoVedasC(), 0); //add full load of basic missiles
		...
		$this->addPrimarySystem(new Hangar(3, 12, 4));
		...
		$this->addLeftSystem(new ChoukaMineLauncher(2, 0, 0, 240, 360, $ammoMagazine, false));
		$this->addLeftSystem(new ChoukaMineLauncher(2, 0, 0, 240, 360, $ammoMagazine, false));
		...
		$this->addRightSystem(new ChoukaMineLauncher(2, 0, 0, 0, 120, $ammoMagazine, false));
		$this->addRightSystem(new ChoukaMineLauncher(2, 0, 0, 0, 120, $ammoMagazine, false));
