<?php
class ChoukaReverenceMonitorRefitAM extends BaseShip{
	...
	$this->faction = "Escalation Wars Chouka Theocracy";
        $this->phpclass = "ChoukaReverenceMonitorRefitAM";
        ...
        $this->addLeftSystem(new MediumPlasma(3, 5, 3, 240, 360));
		$this->addLeftSystem(new AmmoMissileRackSO(3, 0, 0, 180, 60, $ammoMagazine, false));
		$this->addLeftSystem(new AmmoMissileRackSO(3, 0, 0, 180, 60, $ammoMagazine, false));
        ...
        $this->addRightSystem(new MediumPlasma(3, 5, 3, 0, 120));
		$this->addRightSystem(new AmmoMissileRackSO(3, 0, 0, 300, 180, $ammoMagazine, false));
		$this->addRightSystem(new AmmoMissileRackSO(3, 0, 0, 300, 180, $ammoMagazine, false));
