<?php
class ChoukaReverenceMonitorAM extends BaseShip{
	...
	$this->faction = "Escalation Wars Chouka Theocracy";
        $this->phpclass = "ChoukaReverenceMonitorAM";
        $this->imagePath = "img/ships/EscalationWars/ChoukaReverence.png";
        $this->shipClass = "Reverence System Monitor";
        ...
        $this->addLeftSystem(new MediumPlasma(3, 5, 3, 240, 360));
		$this->addLeftSystem(new AmmoMissileRackO(3, 0, 0, 180, 60, $ammoMagazine, false));
		$this->addLeftSystem(new AmmoMissileRackO(3, 0, 0, 180, 60, $ammoMagazine, false));
        ...
        $this->addRightSystem(new MediumPlasma(3, 5, 3, 0, 120));
		$this->addRightSystem(new AmmoMissileRackO(3, 0, 0, 300, 180, $ammoMagazine, false));
		$this->addRightSystem(new AmmoMissileRackO(3, 0, 0, 300, 180, $ammoMagazine, false));
        ...
        $this->addLeftSystem(new Structure(3, 63));
        $this->addRightSystem(new Structure(3, 63));
        $this->addPrimarySystem(new Structure(4, 66));
