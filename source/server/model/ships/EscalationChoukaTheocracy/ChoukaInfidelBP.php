<?php
class ChoukaInfidelBP extends FighterFlight{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "ChoukaInfidelBP";
        $this->shipClass = "Infidel Breaching Pods";
        $this->imagePath = "img/ships/EscalationWars/ChoukaInfidelBP.png";
        $this->isd = 1875;
...
//	    $this->notes = 'Non-atmospheric.';
    ...
    public function populate(){
        ...
        for ($i = 0; $i < $toAdd; $i++){
            ...
            $fighter = new Fighter("ChoukaInfidelBP", $armour, 16, $this->id);
            $fighter->displayName = "Infidel";
            $fighter->imagePath = "img/ships/EscalationWars/ChoukaInfidelBP.png";
            $fighter->iconPath = "img/ships/EscalationWars/ChoukaInfidelBP_large.png";
