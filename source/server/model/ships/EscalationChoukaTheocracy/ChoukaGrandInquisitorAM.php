<?php
class ChoukaGrandInquisitorAM extends BaseShip{
	...
	$this->faction = "Escalation Wars Chouka Theocracy";
        $this->phpclass = "ChoukaGrandInquisitorAM";
	...
	$this->isd = 1927;
        ...
        $ammoMagazine = new AmmoMagazine(16); //pass magazine capacity - 20 rounds per launcher, plus reload rack 80
		...
		$this->addLeftSystem(new AmmoMissileRackO(2, 0, 0, 180, 360, $ammoMagazine, false));
		...
		$this->addRightSystem(new AmmoMissileRackO(2, 0, 0, 0, 180, $ammoMagazine, false));
