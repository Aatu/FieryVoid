...
class Maishan extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addFrontSystem(new HeavyFusionCannon(3, 10, 4, 300, 360));
        ...
        $this->addLeftSystem(new HeavyFusionCannon(3, 10, 4, 240, 360));
        $this->addLeftSystem(new FusionCannon(3, 8, 1, 180, 360));

        
        $this->addRightSystem(new FusionCannon(3, 8, 1, 0, 180));
        $this->addRightSystem(new HeavyFusionCannon(3, 10, 4, 0, 360));
