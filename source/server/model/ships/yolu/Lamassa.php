...
class Lamassa extends OSAT
{
	...
	function __construct($id, $userid, $name,  $slot)
	{
		...
		$this->addFrontSystem(new DestabilizerBeam(4, 10, 4, 300, 60));
		$this->addFrontSystem(new DestabilizerBeam(4, 10, 4, 300, 60));
		$this->addFrontSystem(new FusionCannon(4, 10, 4, 270, 90));
