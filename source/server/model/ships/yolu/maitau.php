<?php
class Maitau extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addFrontSystem(new FusionAgitator(4, 10, 4, 240, 360));
        $this->addFrontSystem(new FusionCannon(3, 8, 1, 240, 60));
        $this->addFrontSystem(new FusionAgitator(3, 10, 4, 300, 60));
        $this->addFrontSystem(new FusionCannon(3, 8, 1, 300, 120));
        $this->addFrontSystem(new FusionAgitator(4, 10, 4, 0, 120));
