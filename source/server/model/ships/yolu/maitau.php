...
class Maitau extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addFrontSystem(new FusionAgitator(3, 10, 4, 300, 360));
        ...
        $this->addLeftSystem(new FusionAgitator(4, 10, 4, 240, 360));
        $this->addLeftSystem(new FusionCannon(3, 8, 1, 180, 360));

		
        $this->addRightSystem(new FusionCannon(3, 8, 1, 0, 180));
        $this->addRightSystem(new FusionAgitator(4, 10, 4, 0, 360));
