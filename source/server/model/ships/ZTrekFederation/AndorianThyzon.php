<?php
class AndorianThyzon extends MediumShip{
	...
	$impulseDrive = new TrekImpulseDrive(3,16,0,1,3); //Impulse Drive is an engine in its own right, in addition to serving as hub for Nacelle output: $armour, $maxhealth, $powerReq, $output, $boostEfficiency
		...
		$this->addFrontSystem($projection);
        	$this->addFrontSystem(new ParticleCannon(3, 8, 6, 300, 60));

        	$this->addAftSystem(new LightParticleCannon(2, 6, 4, 240, 60));
        	$this->addAftSystem(new LightParticleCannon(2, 6, 4, 300, 120));
