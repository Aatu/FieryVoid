...
class Kirva1945 extends OSAT{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "Kirva1945";
        $this->imagePath = "img/ships/AbbaiBochi.png";
        $this->shipClass = 'Kirva Jammer Satellite (1945)';
			$this->occurence = 'rare'; 
        ...
        $this->addPrimarySystem(new SensorSpear(3, 0, 0, 270, 90)); 
        $this->addPrimarySystem(new LightParticleBeamShip(2, 2, 1, 0, 360));
        $this->addPrimarySystem(new CommJammer(3, 0, 0, 270, 90)); 
