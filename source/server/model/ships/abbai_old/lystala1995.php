<?php
class Lystala1995 extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "Lystala1995";
        $this->imagePath = "img/ships/AbbaiKastona.png";
        $this->shipClass = "Lystala Patrol Cruiser (1995)";
        ...
        $this->addFrontSystem(new SensorSpear(2, 0, 0, 240, 360));
        $this->addFrontSystem(new ImpCommJammer(3, 0, 0, 300, 60));
        $this->addFrontSystem(new SensorSpear(2, 0, 0, 0, 120));
        ...
        $this->addAftSystem(new JumpEngine(4, 12, 4, 32));
        $this->addAftSystem(new Thruster(3, 10, 0, 4, 2));
