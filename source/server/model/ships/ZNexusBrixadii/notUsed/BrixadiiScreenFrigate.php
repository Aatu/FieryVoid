...
class BrixadiiScreenFrigate extends LCV{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->imagePath = "img/ships/Nexus/BrixadiiScreenFrigate.png";
		...
		$this->addPrimarySystem(new NexusLightProjectorArray(2, 5, 2, 180, 360));
		$this->addPrimarySystem(new NexusLightProjectorArray(2, 5, 2, 240, 120));
		$this->addPrimarySystem(new NexusLightProjectorArray(2, 5, 2, 240, 120));
		$this->addPrimarySystem(new NexusLightProjectorArray(2, 5, 2, 0, 180));
