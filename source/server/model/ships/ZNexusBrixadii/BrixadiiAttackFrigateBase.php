<?php
class BrixadiiAttackFrigateBase extends MediumShip{
    /*Brixadii Attack Frigate, initial deployment 2056 (Nexus) */
    function __construct($id, $userid, $name,  $slot){
        parent::__construct($id, $userid, $name,  $slot);
        
        $this->pointCost = 305;
        $this->faction = "ZNexus Brixadii";
        $this->phpclass = "BrixadiiAttackFrigateBase";
		...
		$this->addFrontSystem(new NexusParticleAgitator(2, 6, 1, 0, 120));
