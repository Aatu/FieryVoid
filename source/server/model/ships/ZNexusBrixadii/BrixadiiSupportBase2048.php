<?php
class BrixadiiSupportBase2048 extends SmallStarBaseFourSections{
	...
	function __construct($id, $userid, $name,  $slot){
		...
		$this->phpclass = "BrixadiiSupportBase2048";
		$this->shipClass = "Brixadii Support Base (2048)";
		$this->variantOf = "Brixadii Support Base";
		...
		$this->addPrimarySystem(new ParticleHammer(5, 12, 6, 0, 360));
		$this->addPrimarySystem(new LightParticleProjector(5, 3, 1, 0, 360));
		$this->addPrimarySystem(new LightParticleProjector(5, 3, 1, 0, 360));
		$this->addPrimarySystem(new LightParticleProjector(5, 3, 1, 0, 360));
		$this->addPrimarySystem(new LightParticleProjector(5, 3, 1, 0, 360));

		$this->addFrontSystem(new ParticleProjector(4, 6, 1, 270, 90));
		$this->addFrontSystem(new ParticleProjector(4, 6, 1, 270, 90));
		$this->addFrontSystem(new NexusChaffLauncher(4, 2, 1, 270, 90));
		$this->addFrontSystem(new CargoBay(4, 20));
		$this->addFrontSystem(new NexusParticleAgitator(4, 8, 3, 270, 90));
		
		$this->addLeftSystem(new ParticleProjector(4, 6, 1, 180, 360));
		$this->addLeftSystem(new ParticleProjector(4, 6, 1, 180, 360));
		$this->addLeftSystem(new NexusChaffLauncher(4, 2, 1, 180, 360));
		$this->addLeftSystem(new CargoBay(4, 20));
		$this->addLeftSystem(new NexusParticleAgitator(4, 8, 3, 180, 360));

		$this->addRightSystem(new ParticleProjector(4, 6, 1, 0, 180));
		$this->addRightSystem(new ParticleProjector(4, 6, 1, 0, 180));
		$this->addRightSystem(new NexusChaffLauncher(4, 2, 1, 0, 180));
		$this->addRightSystem(new CargoBay(4, 20));
		$this->addRightSystem(new NexusParticleAgitator(4, 8, 3, 0, 180));

		$this->addAftSystem(new ParticleProjector(4, 6, 1, 90, 270));
		$this->addAftSystem(new ParticleProjector(4, 6, 1, 90, 270));
		$this->addAftSystem(new NexusChaffLauncher(4, 2, 1, 90, 270));
		$this->addAftSystem(new CargoBay(4, 20));
		$this->addAftSystem(new NexusParticleAgitator(4, 8, 3, 90, 270));
