<?php
class BrixadiiGunSat2108 extends MicroSAT{
    function __construct($id, $userid, $name,  $slot){
        parent::__construct($id, $userid, $name,  $slot);
        
        $this->pointCost = 60*6;
        $this->faction = "ZNexus Brixadii";
        $this->phpclass = "BrixadiiGunSat2108";
        $this->shipClass = "Brixadii Gun Sat Cluster (2108)";
    ...
    public function populate(){
        ...
        for ($i = 0; $i < $toAdd; $i++){
            ...
            $fighter = new Fighter("Gun Sat 2108", $armour, 28, $this->id);
            $fighter->displayName = "Gun Sat 2108";
            ...
            $lightGun = new NexusProjectorArray(0, 1, 0, 330, 30); 
			$lightGun->isLinked = false;
			$lightGun->shots = 1;
			$lightGun->defaultShots = 1;
			$lightGun->displayName = 'Projector Array';		
			$lightGun->fireControl = array(0, 0, 0); // fighters, <mediums, <capitals	

            $lightGun2 = new NexusProjectorArray(0, 1, 0, 330, 30); 
			$lightGun2->isLinked = false;
			$lightGun2->shots = 1;
			$lightGun2->defaultShots = 1;
			$lightGun2->displayName = 'Projector Array';		
