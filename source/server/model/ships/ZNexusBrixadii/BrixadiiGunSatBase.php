<?php
class BrixadiiGunSatBase extends MicroSAT{
    function __construct($id, $userid, $name,  $slot){
        parent::__construct($id, $userid, $name,  $slot);
        
        $this->pointCost = 60*6;
        $this->faction = "ZNexus Brixadii";
        $this->phpclass = "BrixadiiGunSatBase";
        $this->shipClass = "Brixadii Gun Sat Cluster";
    ...
    public function populate(){
        ...
        for ($i = 0; $i < $toAdd; $i++){
            ...
            $fighter = new Fighter("Gun Sat", $armour, 28, $this->id);
            $fighter->displayName = "Gun Sat";
			...
			$lightGun->displayName = 'Particle Projector';		
			$lightGun->fireControl = array(0, 0, 0); // fighters, <mediums, <capitals	

            $lightGun2 = new ParticleProjector(0, 1, 0, 330, 30); 
			$lightGun2->isLinked = false;
			$lightGun2->shots = 1;
			$lightGun2->defaultShots = 1;
			$lightGun2->displayName = 'Particle Projector';		
