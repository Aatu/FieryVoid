<?php
class Swift extends MediumShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addPrimarySystem(new Reactor(4, 11, 0, 2));
    	...
    	$this->addFrontSystem(new RepeaterGun(3, 6, 4, 240, 0));
    	$this->addFrontSystem(new RepeaterGun(3, 6, 4, 0, 120));
