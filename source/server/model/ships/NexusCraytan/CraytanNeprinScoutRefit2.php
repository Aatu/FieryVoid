<?php
class CraytanNeprinScoutRefit2 extends HeavyCombatVesselLeftRight{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "CraytanNeprinScoutRefit2";
        $this->imagePath = "img/ships/Nexus/craytan_dela.png";
		$this->canvasSize = 125; //img has 200px per side
        $this->shipClass = "Neprin Auxiliary Scout (2123)";
        ...
        $this->hitChart = array(
            ...
            3=> array(
                    ...
                    6 => "Thruster",
					9 => "ELINT Scannter",
					11 => "Advanced Close-In Defense System",
					12 => "Hangar",
					18 => "Structure",
                    20 => "Primary",
            ),
