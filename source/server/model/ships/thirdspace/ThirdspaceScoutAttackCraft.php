<?php
class ThirdspaceScoutAttackCraft extends LCV{ //Actually an LCV.
	...
	$this->phpclass = "ThirdspaceScoutAttackCraft";
	$this->shipClass = "Scout Craft";
    ...
    $this->addPrimarySystem(new AdvancedSingularityDrive(5, 15, 0, 4+8+3));
	...
	$this->addPrimarySystem(new Structure( 5, 36));
        ...
        $this->hitChart = array(
        		0=> array( //should never happen (but it will!)
        				9 => "Structure",
        				11 => "1:Light Psionic Concentrator",  
						12 => "Shield Generator",   
						13 => "Self Repair",        				
        				14 => "Jump Engine",
        				16 => "Engine",
