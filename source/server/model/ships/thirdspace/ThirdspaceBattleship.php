...
class ThirdspaceBattleship extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->addPrimarySystem(new ThirdspaceShield(3, 600, 200, 210, 330, 'L'));		
...
//        $this->addFrontSystem(new PsionicConcentrator(4, 0, 0, 300, 120));                 	          	
		...
		$this->addPrimarySystem(new ThirdspaceShield(3, 300, 100, 330, 30, 'F'));		
...
//        $this->addAftSystem(new PsionicConcentrator(4, 0, 0, 60, 240));                
		...
		$this->addPrimarySystem(new ThirdspaceShield(3, 300, 100, 150, 210, 'A'));	              
...
//        $this->addLeftSystem(new PsionicConcentrator(4, 0, 0, 240, 360));
		...
		$this->addPrimarySystem(new ThirdspaceShield(3, 600, 200, 30, 150, 'R'));
