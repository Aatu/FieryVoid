...
class ThirdspaceBattleship extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$projection = new ThirdspaceShieldProjection(4, 150, 150, 330, 30, 'F');//: $armor, $maxhealth, $rating, $arc from/to - F/A/L/R
		...
		$projection = new ThirdspaceShieldProjection(4, 120, 120, 0, 360, 'A');//: $armor, $maxhealth, $rating, $arc from/to - F/A/L/R
        ...
        $projection = new ThirdspaceShieldProjection(4, 150, 150, 210, 330, 'L');//: $armor, $maxhealth, $rating, $arc from/to - F/A/L/R
        ...
        $projection = new ThirdspaceShieldProjection(4, 150, 150, 30, 150, 'R');//: $armor, $maxhealth, $rating, $arc from/to - F/A/L/R
