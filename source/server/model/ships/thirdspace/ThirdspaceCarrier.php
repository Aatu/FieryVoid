...
class ThirdspaceCarrier extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->addPrimarySystem(new ThirdspaceShield(2, 420, 140, 210, 330, 'L'));		

        $this->addFrontSystem(new PsionicConcentrator(5, 0, 0, 270, 90));
...
//       $this->addFrontSystem(new PsionicConcentrator(4, 0, 0, 300, 120));                         	          	
		...
		$this->addPrimarySystem(new ThirdspaceShield(2, 210, 70, 330, 30, 'F'));		
...
//        $this->addAftSystem(new PsionicConcentrator(4, 0, 0, 60, 240));                         
		...
		$this->addPrimarySystem(new ThirdspaceShield(2, 210, 70, 150, 210, 'A'));
...
//        $this->addLeftSystem(new PsionicConcentrator(4, 0, 0, 240, 360));  
		...
		$this->addPrimarySystem(new ThirdspaceShield(2, 420, 140, 30, 150, 'R'));
