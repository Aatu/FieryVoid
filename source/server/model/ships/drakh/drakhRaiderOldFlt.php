<?php
class DrakhRaiderOldFlt extends FighterFlight{
	...
	$this->factionAge = 2; //1 - Young, 2 - Middleborn, 3 - Ancient, 4 - Primordial
        $this->phpclass = "DrakhRaiderOldFlt";
        $this->shipClass = "Raider Assault Fighters (old version, with separate heavy gun)";
			$this->variantOf = "OBSOLETE";//to be deleted when games using it are finished
    ...
    public function populate(){
        ...
        for ($i = 0; $i < $toAdd; $i++){
            ...
            $fighter = new Fighter("DrakhRaiderOldFlt", $armour, 25, $this->id);
