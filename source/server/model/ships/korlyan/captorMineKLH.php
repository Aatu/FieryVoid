<?php
class captorMineKLH extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addPrimarySystem(new CaptorMine(0, 1, 1, 0, 360, 2, 5, 10, 1, 24)); //$armour, $maxhealth, $powerReq, $startArc, $endArc, $range, $accuracy, $diceType, $dice, $damageBonus
