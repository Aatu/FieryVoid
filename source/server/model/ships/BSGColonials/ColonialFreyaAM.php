<?php
class ColonialFreyaAM extends BaseShip{
...
//		$this->unlimited 
        ...
        $ammoMagazine = new AmmoMagazine(260); //pass magazine capacity - 20 rounds per launcher, plus reload rack 80
		...
		$this->addFrontSystem(new RapidGatling(5, 4, 1, 300, 60));
        $this->addFrontSystem(new AmmoMissileRackL(5, 0, 0, 330, 30, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addFrontSystem(new AmmoMissileRackS(5, 0, 0, 300, 360, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addFrontSystem(new AmmoMissileRackS(5, 0, 0, 330, 30, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addFrontSystem(new AmmoMissileRackS(5, 0, 0, 0, 60, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
		...
		$this->addAftSystem(new RapidGatling(5, 4, 1, 120, 240));
        $this->addAftSystem(new AmmoMissileRackL(4, 0, 0, 120, 240, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addAftSystem(new AmmoMissileRackS(4, 0, 0, 120, 240, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
		...
		$this->addLeftSystem(new RapidGatling(5, 4, 1, 210, 330));
        $this->addLeftSystem(new AmmoMissileRackL(5, 0, 0, 210, 330, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
		...
		$this->addRightSystem(new RapidGatling(5, 4, 1, 30, 150));
        $this->addRightSystem(new AmmoMissileRackL(5, 0, 0, 30, 150, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
