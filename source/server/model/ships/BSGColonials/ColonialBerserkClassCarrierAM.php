<?php
class ColonialBerserkClassCarrierAM extends BaseShip{
	...
	$this->faction = "BSG Colonials";
        $this->phpclass = "ColonialBerserkClassCarrierAM";
...
//		$this->addPrimarySystem(new Bulkhead(0, 5));
		...
		$this->addLeftSystem(new RapidGatling(4, 4, 1, 180, 360));
        $this->addLeftSystem(new RapidGatling(4, 4, 1, 180, 360));
        $this->addLeftSystem(new AmmoMissileRackS(4, 0, 0, 210, 330, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addLeftSystem(new AmmoMissileRackS(4, 0, 0, 210, 330, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        ...
        $this->addRightSystem(new RapidGatling(4, 4, 1, 0, 180));
		$this->addRightSystem(new RapidGatling(4, 4, 1, 0, 180));
        $this->addRightSystem(new AmmoMissileRackS(4, 0, 0, 30, 150, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addRightSystem(new AmmoMissileRackS(4, 0, 0, 30, 150, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
