<?php
class ColonialJupiterClassAM extends BaseShip{
	...
	$this->faction = "BSG Colonials";
        $this->phpclass = "ColonialJupiterClassAM";
...
//		$this->addPrimarySystem(new Thruster(5, 24, 0, 4, 2));
        ...
        $this->addFrontSystem(new AmmoMissileRackL(6, 0, 0, 300, 60, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addFrontSystem(new AmmoMissileRackL(6, 0, 0, 300, 60, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        ...
        $this->addAftSystem(new AmmoMissileRackL(6, 0, 0, 180, 270, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addAftSystem(new AmmoMissileRackL(6, 0, 0, 90, 180, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
