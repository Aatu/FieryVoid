<?php
class ColonialMercuryClassAM extends BaseShip{
	...
	$this->faction = "BSG Colonials";
        $this->phpclass = "ColonialMercuryClassAM";
...
//        $this->notes .= '<br>Provides +5 Initiative for all friendly Colonial units';
        ...
        $this->addAftSystem(new AmmoMissileRackS(6, 0, 0, 150, 210, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
        $this->addAftSystem(new AmmoMissileRackS(6, 0, 0, 150, 210, $ammoMagazine, false)); //$armour, $health (0=auto), $power (0=auto), $startArc, $endArc, $magazine, $base
