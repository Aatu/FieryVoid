...
class GravitonPulsar extends Pulse
{
    ...
    public function fire($gamedata, $fireOrder)
    {
        ...
        if ($this->getBoostLevel($gamedata->turn) === $this->maxBoostLevel) {
            ...
            $crits = $this->testCritical($shooter);
        }
    }
...
class GraviticBolt extends Gravitic
{
    ...
    public function getDamage($fireOrder)
    {return $this->getCurDamage($fireOrder->turn);}
    public function setMinDamage()
    {$this->minDamage = $this->curDamage;}
    public function setMaxDamage()
    {$this->maxDamage = $this->curDamage;}
}
...
class GravitonBeam extends Raking
{
    ...
    public function getDamage($fireOrder)
    {return Dice::d(10, 5) + 12;}
    public function setMinDamage()
    {return $this->minDamage = 17;}
    public function setMaxDamage()
    {return $this->maxDamage = 62;}
}
...
class LightGraviticBolt extends LinkedWeapon
{
    ...
    public function __construct($startArc, $endArc, $damagebonus, $shots = 2)
    {
        $this->shots = $shots;
...
class LightGravitonBeam extends Weapon
{
    ...
    public function __construct($startArc, $endArc, $damagebonus)
    {
        parent::__construct(0, 1, 0, $startArc, $endArc);
    }
    ...
    {return Dice::d(6, 5);}
    public function setMinDamage()
    {return $this->minDamage = 5;}
    public function setMaxDamage()
    {return $this->maxDamage = 30;}
}
...
class GravLance extends Raking
{
    ...
    public function getDamage($fireOrder)
    {return Dice::d(10, 6) + 24;}
    public function setMinDamage()
    {return $this->minDamage = 30;}
    public function setMaxDamage()
    {return $this->maxDamage = 84;}
}
