	...
	*/
    ...
    class MolecularSlicerBeamL extends Raking{
		...
		public function setSystemDataWindow($turn){			
			...
			$this->data["Special"] .= "<br>May target multiple enemies, damage will be evenly distributed across all targets.";
    ...
    class MolecularSlicerBeamM extends MolecularSlicerBeamL{
		...
		public function setSystemDataWindow($turn){			
			...
			$this->data["Special"] .= "<br>May target multiple enemies, damage will be evenly distributed across all targets.";
			//$this->data["Special"] .= "<br>Ships can only be targeted once, but fighters can be targeted as many times as you wish.";
			$this->data["Special"] .= "<br>Can fire accelerated for less damage:"; 
    ...
    class MolecularSlicerBeamH extends MolecularSlicerBeamL{
		...
		public function setSystemDataWindow($turn){			
			...
			$this->data["Special"] .= "<br>May choose to split shots between multiple targets, damage will be evenly distributed across all targets.";
		...
		public function getDamage($fireOrder){
			...
			if($this->firingMode == 1 || $this->firingMode == 3){//cannot use 3-turns power for shots other than Piercing
