<?php
    class Movement{
        ...
        public static function setPreturnMovementStatusForShip($ship, $turn){
            ...
            if ($pivoting == 1){
                $movements[] = new MovementOrder(null, "isPivotingLeft", $lastmove->x, $lastmove->y, 0,0, $lastmove->speed, $lastmove->heading, $lastmove->facing, true, ($turn+1), 0);
                ...
                $movements[] = new MovementOrder(null, "isPivotingRight", $lastmove->x, $lastmove->y, 0,0, $lastmove->speed, $lastmove->heading, $lastmove->facing, true, ($turn+1), 0);
            ...
            if ($rolling){
                $movements[] = new MovementOrder(null, "isRolling", $lastmove->x, $lastmove->y, 0,0, $lastmove->speed, $lastmove->heading, $lastmove->facing, true, ($turn+1), 0);
                $rolled = !$rolled;
            }
            if ($rolled){
                $movements[] = new MovementOrder(null, "isRolled", $lastmove->x, $lastmove->y, 0,0, $lastmove->speed, $lastmove->heading, $lastmove->facing, true, ($turn+1), 0);
            }
