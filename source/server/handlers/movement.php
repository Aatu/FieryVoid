    ...
    class Movement{
        ...
        public static function getOpenVortexInHex($gamedata, OffsetCoordinate $pos){
            foreach ($gamedata->ships as $unit){
                ...
                /* REINFORCEMENTS_PLAN.md §2.6 - ONE-WAY. A blue entrance can never be jumped out
                   of. The subclass passes the instanceof above, so without this line an entrance
                   would be a perfectly legal doorway into hyperspace - and it is the hex arriving
                   reinforcements are standing in, so it would be the easiest exit on the board.
                ...
                if ($unit instanceof SpawnJumpPointEntrance) continue;
        ...
        public static function getJumpOutVortex($movement, $gamedata){
            ...
            //fires on a hand-forged order naming an entrance by id.
            if ($vortex instanceof SpawnJumpPointEntrance) return null;
