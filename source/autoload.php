    ...
    function($class) {
        ...
        if ($classes === null) {
            $classes = array(
                ...
                //custom Narn
                'dagkur' => '/server/model/ships/narn/zzunoffDagkur.php',
            	'gkon' => '/server/model/ships/narn/zzunoffGkon.php',
            	'gtor' => '/server/model/ships/narn/zzunoffGtor.php',
            	'kator' => '/server/model/ships/narn/zzunoffKator.php',
            	'naston' => '/server/model/ships/narn/zzunoffNaston.php',
            	'rongor' => '/server/model/ships/narn/zzunoffRongor.php',
            	'ronvar' => '/server/model/ships/narn/zzunoffRonvar.php',
            	'shokan' => '/server/model/ships/narn/zzunoffShokan.php',
            	'shovok' => '/server/model/ships/narn/zzunoffShovok.php',
            	'shovor' => '/server/model/ships/narn/zzunoffShovor.php',
            	'shovorbolt' => '/server/model/ships/narn/zzunoffShovorBolt.php',
            	'tshon' => '/server/model/ships/narn/zzunoffTshon.php',
            	'tvoth' => '/server/model/ships/narn/zzunoffTvoth.php',
