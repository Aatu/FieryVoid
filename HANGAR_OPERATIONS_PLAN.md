...
Not yet done: escape Pass-2/Pass-3 ordering rewrite (21.4); fleet-list/value cleanup (21.5); live-compat verification (21.6). Player-choice rail-destroy UI and per-structure-point box attrition remain deferred per roadmap.
